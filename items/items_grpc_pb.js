...
function serialize_mruv_CreateItemRequest(arg) {
  if (!(arg instanceof items_items_pb.CreateItemRequest)) {
...
function deserialize_mruv_CreateItemRequest(buffer_arg) {
  return items_items_pb.CreateItemRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_CreateItemResponse(arg) {
  if (!(arg instanceof items_items_pb.CreateItemResponse)) {
...
function deserialize_mruv_CreateItemResponse(buffer_arg) {
  return items_items_pb.CreateItemResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_DestroyItemRequest(arg) {
  if (!(arg instanceof items_items_pb.DestroyItemRequest)) {
...
function deserialize_mruv_DestroyItemRequest(buffer_arg) {
  return items_items_pb.DestroyItemRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_DestroyItemResponse(arg) {
  if (!(arg instanceof items_items_pb.DestroyItemResponse)) {
...
function deserialize_mruv_DestroyItemResponse(buffer_arg) {
  return items_items_pb.DestroyItemResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_GetItemRequest(arg) {
  if (!(arg instanceof items_items_pb.GetItemRequest)) {
...
function deserialize_mruv_GetItemRequest(buffer_arg) {
  return items_items_pb.GetItemRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_GetItemResponse(arg) {
  if (!(arg instanceof items_items_pb.GetItemResponse)) {
...
function deserialize_mruv_GetItemResponse(buffer_arg) {
  return items_items_pb.GetItemResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_mruv_UpdateItemRequest(arg) {
  if (!(arg instanceof items_items_pb.UpdateItemRequest)) {
...
function deserialize_mruv_UpdateItemRequest(buffer_arg) {
  return items_items_pb.UpdateItemRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_UpdateItemResponse(arg) {
  if (!(arg instanceof items_items_pb.UpdateItemResponse)) {
...
function deserialize_mruv_UpdateItemResponse(buffer_arg) {
  return items_items_pb.UpdateItemResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var MruVItemServiceService = exports.MruVItemServiceService = {
  create: {
    ...
    requestType: items_items_pb.CreateItemRequest,
    responseType: items_items_pb.CreateItemResponse,
  ...
  destroy: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: items_items_pb.DestroyItemRequest,
    responseType: items_items_pb.DestroyItemResponse,
  ...
  update: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: items_items_pb.UpdateItemRequest,
    responseType: items_items_pb.UpdateItemResponse,
  ...
  get: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: items_items_pb.GetItemRequest,
    responseType: items_items_pb.GetItemResponse,
