...
interface IMruVItemServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  updateItem: grpc.MethodDefinition<items_items_model_pb.Item, items_items_model_pb.ItemID>;
  ...
  updateItemType: grpc.MethodDefinition<items_items_model_pb.ItemType, items_items_model_pb.ItemTypeID>;
  ...
  updateContainer: grpc.MethodDefinition<items_items_model_pb.Container, items_items_model_pb.ContainerID>;
...
export class MruVItemServiceClient extends grpc.Client {
  ...
  updateItem(argument: items_items_model_pb.Item, callback: grpc.requestCallback<items_items_model_pb.ItemID>): grpc.ClientUnaryCall;
  updateItem(argument: items_items_model_pb.Item, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<items_items_model_pb.ItemID>): grpc.ClientUnaryCall;
  updateItem(argument: items_items_model_pb.Item, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<items_items_model_pb.ItemID>): grpc.ClientUnaryCall;
  ...
  updateItemType(argument: items_items_model_pb.ItemType, callback: grpc.requestCallback<items_items_model_pb.ItemTypeID>): grpc.ClientUnaryCall;
  updateItemType(argument: items_items_model_pb.ItemType, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<items_items_model_pb.ItemTypeID>): grpc.ClientUnaryCall;
  updateItemType(argument: items_items_model_pb.ItemType, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<items_items_model_pb.ItemTypeID>): grpc.ClientUnaryCall;
  ...
  updateContainer(argument: items_items_model_pb.Container, callback: grpc.requestCallback<items_items_model_pb.ContainerID>): grpc.ClientUnaryCall;
  updateContainer(argument: items_items_model_pb.Container, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<items_items_model_pb.ContainerID>): grpc.ClientUnaryCall;
  updateContainer(argument: items_items_model_pb.Container, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<items_items_model_pb.ContainerID>): grpc.ClientUnaryCall;
  ...
  getContainerItems(argument: items_items_model_pb.ContainerID, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<items_items_pb.GetContainerItemsResponse>): grpc.ClientUnaryCall;
  getContainerItems(argument: items_items_model_pb.ContainerID, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<items_items_pb.GetContainerItemsResponse>): grpc.ClientUnaryCall;
