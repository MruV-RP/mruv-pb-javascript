...
function deserialize_mruv_plots_CreatePlotRequest(buffer_arg) {
  return plot_plots_pb.CreatePlotRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_plots_CreatePlotResponse(arg) {
  if (!(arg instanceof plot_plots_pb.CreatePlotResponse)) {
...
function deserialize_mruv_plots_CreatePlotResponse(buffer_arg) {
  return plot_plots_pb.CreatePlotResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_plots_DeletePlotRequest(arg) {
  if (!(arg instanceof plot_plots_pb.DeletePlotRequest)) {
...
function deserialize_mruv_plots_DeletePlotRequest(buffer_arg) {
  return plot_plots_pb.DeletePlotRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_plots_DeletePlotResponse(arg) {
  if (!(arg instanceof plot_plots_pb.DeletePlotResponse)) {
...
function deserialize_mruv_plots_DeletePlotResponse(buffer_arg) {
  return plot_plots_pb.DeletePlotResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_plots_GetPlotRequest(arg) {
  if (!(arg instanceof plot_plots_pb.GetPlotRequest)) {
...
function deserialize_mruv_plots_GetPlotRequest(buffer_arg) {
  return plot_plots_pb.GetPlotRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_plots_GetPlotResponse(arg) {
  if (!(arg instanceof plot_plots_pb.GetPlotResponse)) {
...
function deserialize_mruv_plots_GetPlotResponse(buffer_arg) {
  return plot_plots_pb.GetPlotResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_plots_UpdatePlotRequest(arg) {
  if (!(arg instanceof plot_plots_pb.UpdatePlotRequest)) {
...
function deserialize_mruv_plots_UpdatePlotRequest(buffer_arg) {
  return plot_plots_pb.UpdatePlotRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mruv_plots_UpdatePlotResponse(arg) {
  if (!(arg instanceof plot_plots_pb.UpdatePlotResponse)) {
...
function deserialize_mruv_plots_UpdatePlotResponse(buffer_arg) {
  return plot_plots_pb.UpdatePlotResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var MruVPlotsServiceService = exports.MruVPlotsServiceService = {
  ...
  createPlot: {
    ...
    requestType: plot_plots_pb.CreatePlotRequest,
    responseType: plot_plots_pb.CreatePlotResponse,
  ...
  getPlot: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: plot_plots_pb.GetPlotRequest,
    responseType: plot_plots_pb.GetPlotResponse,
  ...
  updatePlot: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: plot_plots_pb.UpdatePlotRequest,
    responseType: plot_plots_pb.UpdatePlotResponse,
  ...
  deletePlot: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: plot_plots_pb.DeletePlotRequest,
    responseType: plot_plots_pb.DeletePlotResponse,
