...
interface IMruVMovableObjectsServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  fetchAllMovableObjects: grpc.MethodDefinition<objects_movable_pb.FetchAllMovableObjectsRequest, objects_movable_pb.FetchAllMovableObjectsResponse>;
}
...
export class MruVMovableObjectsServiceClient extends grpc.Client {
  ...
  fetchAllMovableObjects(argument: objects_movable_pb.FetchAllMovableObjectsRequest, metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null): grpc.ClientReadableStream<objects_movable_pb.FetchAllMovableObjectsResponse>;
  fetchAllMovableObjects(argument: objects_movable_pb.FetchAllMovableObjectsRequest, metadata?: grpc.Metadata | null, options?: grpc.CallOptions | null): grpc.ClientReadableStream<objects_movable_pb.FetchAllMovableObjectsResponse>;
}
