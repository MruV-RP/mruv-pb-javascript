...
interface IMruVGroupsServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  createGroup: grpc.MethodDefinition<groups_groups_model_pb.Group, groups_groups_pb.GroupID>;
  getGroup: grpc.MethodDefinition<groups_groups_pb.GroupID, groups_groups_model_pb.Group>;
  updateGroup: grpc.MethodDefinition<groups_groups_model_pb.Group, groups_groups_pb.GroupID>;
  deleteGroup: grpc.MethodDefinition<groups_groups_pb.GroupID, groups_groups_pb.GroupID>;
...
export class MruVGroupsServiceClient extends grpc.Client {
  ...
  createGroup(argument: groups_groups_model_pb.Group, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  createGroup(argument: groups_groups_model_pb.Group, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  createGroup(argument: groups_groups_model_pb.Group, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  getGroup(argument: groups_groups_pb.GroupID, callback: grpc.requestCallback<groups_groups_model_pb.Group>): grpc.ClientUnaryCall;
  getGroup(argument: groups_groups_pb.GroupID, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_model_pb.Group>): grpc.ClientUnaryCall;
  getGroup(argument: groups_groups_pb.GroupID, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_model_pb.Group>): grpc.ClientUnaryCall;
  updateGroup(argument: groups_groups_model_pb.Group, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  updateGroup(argument: groups_groups_model_pb.Group, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  updateGroup(argument: groups_groups_model_pb.Group, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  deleteGroup(argument: groups_groups_pb.GroupID, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  deleteGroup(argument: groups_groups_pb.GroupID, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  deleteGroup(argument: groups_groups_pb.GroupID, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
