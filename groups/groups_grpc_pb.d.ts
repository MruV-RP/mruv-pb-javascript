...
interface IMruVGroupsServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  createGroup: grpc.MethodDefinition<groups_groups_pb.Group, groups_groups_pb.GroupID>;
  getGroup: grpc.MethodDefinition<groups_groups_pb.GroupID, groups_groups_pb.Group>;
...
export class MruVGroupsServiceClient extends grpc.Client {
  ...
  createGroup(argument: groups_groups_pb.Group, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  createGroup(argument: groups_groups_pb.Group, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  createGroup(argument: groups_groups_pb.Group, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_pb.GroupID>): grpc.ClientUnaryCall;
  getGroup(argument: groups_groups_pb.GroupID, callback: grpc.requestCallback<groups_groups_pb.Group>): grpc.ClientUnaryCall;
  getGroup(argument: groups_groups_pb.GroupID, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_pb.Group>): grpc.ClientUnaryCall;
  getGroup(argument: groups_groups_pb.GroupID, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<groups_groups_pb.Group>): grpc.ClientUnaryCall;
