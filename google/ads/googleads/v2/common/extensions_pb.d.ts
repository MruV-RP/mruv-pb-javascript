...
export class AppFeedItem extends jspb.Message {
  ...
  getAppStore(): google_ads_googleads_v2_enums_app_store_pb.AppStoreEnum.AppStoreMap[keyof google_ads_googleads_v2_enums_app_store_pb.AppStoreEnum.AppStoreMap];
  setAppStore(value: google_ads_googleads_v2_enums_app_store_pb.AppStoreEnum.AppStoreMap[keyof google_ads_googleads_v2_enums_app_store_pb.AppStoreEnum.AppStoreMap]): void;
...
export namespace AppFeedItem {
  export type AsObject = {
    ...
    appStore: google_ads_googleads_v2_enums_app_store_pb.AppStoreEnum.AppStoreMap[keyof google_ads_googleads_v2_enums_app_store_pb.AppStoreEnum.AppStoreMap],
...
export class CallFeedItem extends jspb.Message {
  ...
  getCallConversionReportingState(): google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap[keyof google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap];
  setCallConversionReportingState(value: google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap[keyof google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap]): void;
...
export namespace CallFeedItem {
  export type AsObject = {
    ...
    callConversionReportingState: google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap[keyof google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap],
  }
}
...
export class PriceFeedItem extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_price_extension_type_pb.PriceExtensionTypeEnum.PriceExtensionTypeMap[keyof google_ads_googleads_v2_enums_price_extension_type_pb.PriceExtensionTypeEnum.PriceExtensionTypeMap];
  setType(value: google_ads_googleads_v2_enums_price_extension_type_pb.PriceExtensionTypeEnum.PriceExtensionTypeMap[keyof google_ads_googleads_v2_enums_price_extension_type_pb.PriceExtensionTypeEnum.PriceExtensionTypeMap]): void;

  getPriceQualifier(): google_ads_googleads_v2_enums_price_extension_price_qualifier_pb.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifierMap[keyof google_ads_googleads_v2_enums_price_extension_price_qualifier_pb.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifierMap];
  setPriceQualifier(value: google_ads_googleads_v2_enums_price_extension_price_qualifier_pb.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifierMap[keyof google_ads_googleads_v2_enums_price_extension_price_qualifier_pb.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifierMap]): void;
...
export namespace PriceFeedItem {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_price_extension_type_pb.PriceExtensionTypeEnum.PriceExtensionTypeMap[keyof google_ads_googleads_v2_enums_price_extension_type_pb.PriceExtensionTypeEnum.PriceExtensionTypeMap],
    priceQualifier: google_ads_googleads_v2_enums_price_extension_price_qualifier_pb.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifierMap[keyof google_ads_googleads_v2_enums_price_extension_price_qualifier_pb.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifierMap],
    trackingUrlTemplate?: google_protobuf_wrappers_pb.StringValue.AsObject,
...
export class PriceOffer extends jspb.Message {
  ...
  getUnit(): google_ads_googleads_v2_enums_price_extension_price_unit_pb.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnitMap[keyof google_ads_googleads_v2_enums_price_extension_price_unit_pb.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnitMap];
  setUnit(value: google_ads_googleads_v2_enums_price_extension_price_unit_pb.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnitMap[keyof google_ads_googleads_v2_enums_price_extension_price_unit_pb.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnitMap]): void;
...
export namespace PriceOffer {
  export type AsObject = {
    ...
    unit: google_ads_googleads_v2_enums_price_extension_price_unit_pb.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnitMap[keyof google_ads_googleads_v2_enums_price_extension_price_unit_pb.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnitMap],
    finalUrlsList: Array<google_protobuf_wrappers_pb.StringValue.AsObject>,
    finalMobileUrlsList: Array<google_protobuf_wrappers_pb.StringValue.AsObject>,
  }
}
...
export class PromotionFeedItem extends jspb.Message {
  ...
  getDiscountModifier(): google_ads_googleads_v2_enums_promotion_extension_discount_modifier_pb.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifierMap[keyof google_ads_googleads_v2_enums_promotion_extension_discount_modifier_pb.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifierMap];
  setDiscountModifier(value: google_ads_googleads_v2_enums_promotion_extension_discount_modifier_pb.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifierMap[keyof google_ads_googleads_v2_enums_promotion_extension_discount_modifier_pb.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifierMap]): void;
  ...
  getOccasion(): google_ads_googleads_v2_enums_promotion_extension_occasion_pb.PromotionExtensionOccasionEnum.PromotionExtensionOccasionMap[keyof google_ads_googleads_v2_enums_promotion_extension_occasion_pb.PromotionExtensionOccasionEnum.PromotionExtensionOccasionMap];
  setOccasion(value: google_ads_googleads_v2_enums_promotion_extension_occasion_pb.PromotionExtensionOccasionEnum.PromotionExtensionOccasionMap[keyof google_ads_googleads_v2_enums_promotion_extension_occasion_pb.PromotionExtensionOccasionEnum.PromotionExtensionOccasionMap]): void;
...
export namespace PromotionFeedItem {
  export type AsObject = {
    ...
    discountModifier: google_ads_googleads_v2_enums_promotion_extension_discount_modifier_pb.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifierMap[keyof google_ads_googleads_v2_enums_promotion_extension_discount_modifier_pb.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifierMap],
    ...
    occasion: google_ads_googleads_v2_enums_promotion_extension_occasion_pb.PromotionExtensionOccasionEnum.PromotionExtensionOccasionMap[keyof google_ads_googleads_v2_enums_promotion_extension_occasion_pb.PromotionExtensionOccasionEnum.PromotionExtensionOccasionMap],
    finalUrlsList: Array<google_protobuf_wrappers_pb.StringValue.AsObject>,
    finalMobileUrlsList: Array<google_protobuf_wrappers_pb.StringValue.AsObject>,
    trackingUrlTemplate?: google_protobuf_wrappers_pb.StringValue.AsObject,
    urlCustomParametersList: Array<google_ads_googleads_v2_common_custom_parameter_pb.CustomParameter.AsObject>,
