...
export class FinalAppUrl extends jspb.Message {
  getOsType(): google_ads_googleads_v2_enums_app_url_operating_system_type_pb.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemTypeMap[keyof google_ads_googleads_v2_enums_app_url_operating_system_type_pb.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemTypeMap];
  setOsType(value: google_ads_googleads_v2_enums_app_url_operating_system_type_pb.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemTypeMap[keyof google_ads_googleads_v2_enums_app_url_operating_system_type_pb.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemTypeMap]): void;
...
export namespace FinalAppUrl {
  export type AsObject = {
    osType: google_ads_googleads_v2_enums_app_url_operating_system_type_pb.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemTypeMap[keyof google_ads_googleads_v2_enums_app_url_operating_system_type_pb.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemTypeMap],
