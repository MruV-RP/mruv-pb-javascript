...
export class KeywordInfo extends jspb.Message {
  ...
  getMatchType(): google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap[keyof google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap];
  setMatchType(value: google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap[keyof google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap]): void;
...
export namespace KeywordInfo {
  export type AsObject = {
    ...
    matchType: google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap[keyof google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap],
  }
}
...
export class DeviceInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap[keyof google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap];
  setType(value: google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap[keyof google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap]): void;
...
export namespace DeviceInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap[keyof google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap],
  }
}

export class PreferredContentInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_preferred_content_type_pb.PreferredContentTypeEnum.PreferredContentTypeMap[keyof google_ads_googleads_v2_enums_preferred_content_type_pb.PreferredContentTypeEnum.PreferredContentTypeMap];
  setType(value: google_ads_googleads_v2_enums_preferred_content_type_pb.PreferredContentTypeEnum.PreferredContentTypeMap[keyof google_ads_googleads_v2_enums_preferred_content_type_pb.PreferredContentTypeEnum.PreferredContentTypeMap]): void;
...
export namespace PreferredContentInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_preferred_content_type_pb.PreferredContentTypeEnum.PreferredContentTypeMap[keyof google_ads_googleads_v2_enums_preferred_content_type_pb.PreferredContentTypeEnum.PreferredContentTypeMap],
  }
}

export class ListingGroupInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_listing_group_type_pb.ListingGroupTypeEnum.ListingGroupTypeMap[keyof google_ads_googleads_v2_enums_listing_group_type_pb.ListingGroupTypeEnum.ListingGroupTypeMap];
  setType(value: google_ads_googleads_v2_enums_listing_group_type_pb.ListingGroupTypeEnum.ListingGroupTypeMap[keyof google_ads_googleads_v2_enums_listing_group_type_pb.ListingGroupTypeEnum.ListingGroupTypeMap]): void;
...
export namespace ListingGroupInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_listing_group_type_pb.ListingGroupTypeEnum.ListingGroupTypeMap[keyof google_ads_googleads_v2_enums_listing_group_type_pb.ListingGroupTypeEnum.ListingGroupTypeMap],
...
export class ListingCustomAttributeInfo extends jspb.Message {
  ...
  getIndex(): google_ads_googleads_v2_enums_listing_custom_attribute_index_pb.ListingCustomAttributeIndexEnum.ListingCustomAttributeIndexMap[keyof google_ads_googleads_v2_enums_listing_custom_attribute_index_pb.ListingCustomAttributeIndexEnum.ListingCustomAttributeIndexMap];
  setIndex(value: google_ads_googleads_v2_enums_listing_custom_attribute_index_pb.ListingCustomAttributeIndexEnum.ListingCustomAttributeIndexMap[keyof google_ads_googleads_v2_enums_listing_custom_attribute_index_pb.ListingCustomAttributeIndexEnum.ListingCustomAttributeIndexMap]): void;
...
export namespace ListingCustomAttributeInfo {
  export type AsObject = {
    value?: google_protobuf_wrappers_pb.StringValue.AsObject,
    index: google_ads_googleads_v2_enums_listing_custom_attribute_index_pb.ListingCustomAttributeIndexEnum.ListingCustomAttributeIndexMap[keyof google_ads_googleads_v2_enums_listing_custom_attribute_index_pb.ListingCustomAttributeIndexEnum.ListingCustomAttributeIndexMap],
  }
}
...
export class ProductBiddingCategoryInfo extends jspb.Message {
  ...
  getLevel(): google_ads_googleads_v2_enums_product_bidding_category_level_pb.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevelMap[keyof google_ads_googleads_v2_enums_product_bidding_category_level_pb.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevelMap];
  setLevel(value: google_ads_googleads_v2_enums_product_bidding_category_level_pb.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevelMap[keyof google_ads_googleads_v2_enums_product_bidding_category_level_pb.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevelMap]): void;
...
export namespace ProductBiddingCategoryInfo {
  export type AsObject = {
    ...
    level: google_ads_googleads_v2_enums_product_bidding_category_level_pb.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevelMap[keyof google_ads_googleads_v2_enums_product_bidding_category_level_pb.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevelMap],
  }
}

export class ProductChannelInfo extends jspb.Message {
  getChannel(): google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap[keyof google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap];
  setChannel(value: google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap[keyof google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap]): void;
...
export namespace ProductChannelInfo {
  export type AsObject = {
    channel: google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap[keyof google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap],
  }
}

export class ProductChannelExclusivityInfo extends jspb.Message {
  getChannelExclusivity(): google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap[keyof google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap];
  setChannelExclusivity(value: google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap[keyof google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap]): void;
...
export namespace ProductChannelExclusivityInfo {
  export type AsObject = {
    channelExclusivity: google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap[keyof google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap],
  }
}

export class ProductConditionInfo extends jspb.Message {
  getCondition(): google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap[keyof google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap];
  setCondition(value: google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap[keyof google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap]): void;
...
export namespace ProductConditionInfo {
  export type AsObject = {
    condition: google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap[keyof google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap],
  }
}
...
export class ProductTypeInfo extends jspb.Message {
  ...
  getLevel(): google_ads_googleads_v2_enums_product_type_level_pb.ProductTypeLevelEnum.ProductTypeLevelMap[keyof google_ads_googleads_v2_enums_product_type_level_pb.ProductTypeLevelEnum.ProductTypeLevelMap];
  setLevel(value: google_ads_googleads_v2_enums_product_type_level_pb.ProductTypeLevelEnum.ProductTypeLevelMap[keyof google_ads_googleads_v2_enums_product_type_level_pb.ProductTypeLevelEnum.ProductTypeLevelMap]): void;
...
export namespace ProductTypeInfo {
  export type AsObject = {
    value?: google_protobuf_wrappers_pb.StringValue.AsObject,
    level: google_ads_googleads_v2_enums_product_type_level_pb.ProductTypeLevelEnum.ProductTypeLevelMap[keyof google_ads_googleads_v2_enums_product_type_level_pb.ProductTypeLevelEnum.ProductTypeLevelMap],
  }
}
...
export class HotelDateSelectionTypeInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap[keyof google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap];
  setType(value: google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap[keyof google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap]): void;
...
export namespace HotelDateSelectionTypeInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap[keyof google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap],
  }
}
...
export class HotelCheckInDayInfo extends jspb.Message {
  getDayOfWeek(): google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap[keyof google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap];
  setDayOfWeek(value: google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap[keyof google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap]): void;
...
export namespace HotelCheckInDayInfo {
  export type AsObject = {
    dayOfWeek: google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap[keyof google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap],
  }
}

export class InteractionTypeInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_interaction_type_pb.InteractionTypeEnum.InteractionTypeMap[keyof google_ads_googleads_v2_enums_interaction_type_pb.InteractionTypeEnum.InteractionTypeMap];
  setType(value: google_ads_googleads_v2_enums_interaction_type_pb.InteractionTypeEnum.InteractionTypeMap[keyof google_ads_googleads_v2_enums_interaction_type_pb.InteractionTypeEnum.InteractionTypeMap]): void;
...
export namespace InteractionTypeInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_interaction_type_pb.InteractionTypeEnum.InteractionTypeMap[keyof google_ads_googleads_v2_enums_interaction_type_pb.InteractionTypeEnum.InteractionTypeMap],
  }
}

export class AdScheduleInfo extends jspb.Message {
  getStartMinute(): google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap[keyof google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap];
  setStartMinute(value: google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap[keyof google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap]): void;

  getEndMinute(): google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap[keyof google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap];
  setEndMinute(value: google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap[keyof google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap]): void;
...
export namespace AdScheduleInfo {
  export type AsObject = {
    startMinute: google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap[keyof google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap],
    endMinute: google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap[keyof google_ads_googleads_v2_enums_minute_of_hour_pb.MinuteOfHourEnum.MinuteOfHourMap],
...
export class AgeRangeInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_age_range_type_pb.AgeRangeTypeEnum.AgeRangeTypeMap[keyof google_ads_googleads_v2_enums_age_range_type_pb.AgeRangeTypeEnum.AgeRangeTypeMap];
  setType(value: google_ads_googleads_v2_enums_age_range_type_pb.AgeRangeTypeEnum.AgeRangeTypeMap[keyof google_ads_googleads_v2_enums_age_range_type_pb.AgeRangeTypeEnum.AgeRangeTypeMap]): void;
...
export namespace AgeRangeInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_age_range_type_pb.AgeRangeTypeEnum.AgeRangeTypeMap[keyof google_ads_googleads_v2_enums_age_range_type_pb.AgeRangeTypeEnum.AgeRangeTypeMap],
  }
}

export class GenderInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_gender_type_pb.GenderTypeEnum.GenderTypeMap[keyof google_ads_googleads_v2_enums_gender_type_pb.GenderTypeEnum.GenderTypeMap];
  setType(value: google_ads_googleads_v2_enums_gender_type_pb.GenderTypeEnum.GenderTypeMap[keyof google_ads_googleads_v2_enums_gender_type_pb.GenderTypeEnum.GenderTypeMap]): void;
...
export namespace GenderInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_gender_type_pb.GenderTypeEnum.GenderTypeMap[keyof google_ads_googleads_v2_enums_gender_type_pb.GenderTypeEnum.GenderTypeMap],
  }
}

export class IncomeRangeInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_income_range_type_pb.IncomeRangeTypeEnum.IncomeRangeTypeMap[keyof google_ads_googleads_v2_enums_income_range_type_pb.IncomeRangeTypeEnum.IncomeRangeTypeMap];
  setType(value: google_ads_googleads_v2_enums_income_range_type_pb.IncomeRangeTypeEnum.IncomeRangeTypeMap[keyof google_ads_googleads_v2_enums_income_range_type_pb.IncomeRangeTypeEnum.IncomeRangeTypeMap]): void;
...
export namespace IncomeRangeInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_income_range_type_pb.IncomeRangeTypeEnum.IncomeRangeTypeMap[keyof google_ads_googleads_v2_enums_income_range_type_pb.IncomeRangeTypeEnum.IncomeRangeTypeMap],
  }
}

export class ParentalStatusInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_parental_status_type_pb.ParentalStatusTypeEnum.ParentalStatusTypeMap[keyof google_ads_googleads_v2_enums_parental_status_type_pb.ParentalStatusTypeEnum.ParentalStatusTypeMap];
  setType(value: google_ads_googleads_v2_enums_parental_status_type_pb.ParentalStatusTypeEnum.ParentalStatusTypeMap[keyof google_ads_googleads_v2_enums_parental_status_type_pb.ParentalStatusTypeEnum.ParentalStatusTypeMap]): void;
...
export namespace ParentalStatusInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_parental_status_type_pb.ParentalStatusTypeEnum.ParentalStatusTypeMap[keyof google_ads_googleads_v2_enums_parental_status_type_pb.ParentalStatusTypeEnum.ParentalStatusTypeMap],
  }
}
...
export class ProximityInfo extends jspb.Message {
  ...
  getRadiusUnits(): google_ads_googleads_v2_enums_proximity_radius_units_pb.ProximityRadiusUnitsEnum.ProximityRadiusUnitsMap[keyof google_ads_googleads_v2_enums_proximity_radius_units_pb.ProximityRadiusUnitsEnum.ProximityRadiusUnitsMap];
  setRadiusUnits(value: google_ads_googleads_v2_enums_proximity_radius_units_pb.ProximityRadiusUnitsEnum.ProximityRadiusUnitsMap[keyof google_ads_googleads_v2_enums_proximity_radius_units_pb.ProximityRadiusUnitsEnum.ProximityRadiusUnitsMap]): void;
...
export namespace ProximityInfo {
  export type AsObject = {
    ...
    radiusUnits: google_ads_googleads_v2_enums_proximity_radius_units_pb.ProximityRadiusUnitsEnum.ProximityRadiusUnitsMap[keyof google_ads_googleads_v2_enums_proximity_radius_units_pb.ProximityRadiusUnitsEnum.ProximityRadiusUnitsMap],
...
export class ContentLabelInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_content_label_type_pb.ContentLabelTypeEnum.ContentLabelTypeMap[keyof google_ads_googleads_v2_enums_content_label_type_pb.ContentLabelTypeEnum.ContentLabelTypeMap];
  setType(value: google_ads_googleads_v2_enums_content_label_type_pb.ContentLabelTypeEnum.ContentLabelTypeMap[keyof google_ads_googleads_v2_enums_content_label_type_pb.ContentLabelTypeEnum.ContentLabelTypeMap]): void;
...
export namespace ContentLabelInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_content_label_type_pb.ContentLabelTypeEnum.ContentLabelTypeMap[keyof google_ads_googleads_v2_enums_content_label_type_pb.ContentLabelTypeEnum.ContentLabelTypeMap],
  }
}
...
export class WebpageConditionInfo extends jspb.Message {
  getOperand(): google_ads_googleads_v2_enums_webpage_condition_operand_pb.WebpageConditionOperandEnum.WebpageConditionOperandMap[keyof google_ads_googleads_v2_enums_webpage_condition_operand_pb.WebpageConditionOperandEnum.WebpageConditionOperandMap];
  setOperand(value: google_ads_googleads_v2_enums_webpage_condition_operand_pb.WebpageConditionOperandEnum.WebpageConditionOperandMap[keyof google_ads_googleads_v2_enums_webpage_condition_operand_pb.WebpageConditionOperandEnum.WebpageConditionOperandMap]): void;

  getOperator(): google_ads_googleads_v2_enums_webpage_condition_operator_pb.WebpageConditionOperatorEnum.WebpageConditionOperatorMap[keyof google_ads_googleads_v2_enums_webpage_condition_operator_pb.WebpageConditionOperatorEnum.WebpageConditionOperatorMap];
  setOperator(value: google_ads_googleads_v2_enums_webpage_condition_operator_pb.WebpageConditionOperatorEnum.WebpageConditionOperatorMap[keyof google_ads_googleads_v2_enums_webpage_condition_operator_pb.WebpageConditionOperatorEnum.WebpageConditionOperatorMap]): void;
...
export namespace WebpageConditionInfo {
  export type AsObject = {
    operand: google_ads_googleads_v2_enums_webpage_condition_operand_pb.WebpageConditionOperandEnum.WebpageConditionOperandMap[keyof google_ads_googleads_v2_enums_webpage_condition_operand_pb.WebpageConditionOperandEnum.WebpageConditionOperandMap],
    operator: google_ads_googleads_v2_enums_webpage_condition_operator_pb.WebpageConditionOperatorEnum.WebpageConditionOperatorMap[keyof google_ads_googleads_v2_enums_webpage_condition_operator_pb.WebpageConditionOperatorEnum.WebpageConditionOperatorMap],
...
export class AppPaymentModelInfo extends jspb.Message {
  getType(): google_ads_googleads_v2_enums_app_payment_model_type_pb.AppPaymentModelTypeEnum.AppPaymentModelTypeMap[keyof google_ads_googleads_v2_enums_app_payment_model_type_pb.AppPaymentModelTypeEnum.AppPaymentModelTypeMap];
  setType(value: google_ads_googleads_v2_enums_app_payment_model_type_pb.AppPaymentModelTypeEnum.AppPaymentModelTypeMap[keyof google_ads_googleads_v2_enums_app_payment_model_type_pb.AppPaymentModelTypeEnum.AppPaymentModelTypeMap]): void;
...
export namespace AppPaymentModelInfo {
  export type AsObject = {
    type: google_ads_googleads_v2_enums_app_payment_model_type_pb.AppPaymentModelTypeEnum.AppPaymentModelTypeMap[keyof google_ads_googleads_v2_enums_app_payment_model_type_pb.AppPaymentModelTypeEnum.AppPaymentModelTypeMap],
  }
}
...
export class LocationGroupInfo extends jspb.Message {
  ...
  getRadiusUnits(): google_ads_googleads_v2_enums_location_group_radius_units_pb.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnitsMap[keyof google_ads_googleads_v2_enums_location_group_radius_units_pb.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnitsMap];
  setRadiusUnits(value: google_ads_googleads_v2_enums_location_group_radius_units_pb.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnitsMap[keyof google_ads_googleads_v2_enums_location_group_radius_units_pb.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnitsMap]): void;
...
export namespace LocationGroupInfo {
  export type AsObject = {
    ...
    radiusUnits: google_ads_googleads_v2_enums_location_group_radius_units_pb.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnitsMap[keyof google_ads_googleads_v2_enums_location_group_radius_units_pb.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnitsMap],
  }
}
