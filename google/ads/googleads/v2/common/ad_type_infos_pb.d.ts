...
export class CallOnlyAdInfo extends jspb.Message {
  ...
  getConversionReportingState(): google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap[keyof google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap];
  setConversionReportingState(value: google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap[keyof google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap]): void;
...
export namespace CallOnlyAdInfo {
  export type AsObject = {
    ...
    conversionReportingState: google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap[keyof google_ads_googleads_v2_enums_call_conversion_reporting_state_pb.CallConversionReportingStateEnum.CallConversionReportingStateMap],
  }
}
...
export class ImageAdInfo extends jspb.Message {
  ...
  getMimeType(): google_ads_googleads_v2_enums_mime_type_pb.MimeTypeEnum.MimeTypeMap[keyof google_ads_googleads_v2_enums_mime_type_pb.MimeTypeEnum.MimeTypeMap];
  setMimeType(value: google_ads_googleads_v2_enums_mime_type_pb.MimeTypeEnum.MimeTypeMap[keyof google_ads_googleads_v2_enums_mime_type_pb.MimeTypeEnum.MimeTypeMap]): void;
...
export namespace ImageAdInfo {
  export type AsObject = {
    ...
    mimeType: google_ads_googleads_v2_enums_mime_type_pb.MimeTypeEnum.MimeTypeMap[keyof google_ads_googleads_v2_enums_mime_type_pb.MimeTypeEnum.MimeTypeMap],
...
export class LegacyResponsiveDisplayAdInfo extends jspb.Message {
  ...
  getFormatSetting(): google_ads_googleads_v2_enums_display_ad_format_setting_pb.DisplayAdFormatSettingEnum.DisplayAdFormatSettingMap[keyof google_ads_googleads_v2_enums_display_ad_format_setting_pb.DisplayAdFormatSettingEnum.DisplayAdFormatSettingMap];
  setFormatSetting(value: google_ads_googleads_v2_enums_display_ad_format_setting_pb.DisplayAdFormatSettingEnum.DisplayAdFormatSettingMap[keyof google_ads_googleads_v2_enums_display_ad_format_setting_pb.DisplayAdFormatSettingEnum.DisplayAdFormatSettingMap]): void;
...
export namespace LegacyResponsiveDisplayAdInfo {
  export type AsObject = {
    ...
    formatSetting: google_ads_googleads_v2_enums_display_ad_format_setting_pb.DisplayAdFormatSettingEnum.DisplayAdFormatSettingMap[keyof google_ads_googleads_v2_enums_display_ad_format_setting_pb.DisplayAdFormatSettingEnum.DisplayAdFormatSettingMap],
...
export class LegacyAppInstallAdInfo extends jspb.Message {
  ...
  getAppStore(): google_ads_googleads_v2_enums_legacy_app_install_ad_app_store_pb.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStoreMap[keyof google_ads_googleads_v2_enums_legacy_app_install_ad_app_store_pb.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStoreMap];
  setAppStore(value: google_ads_googleads_v2_enums_legacy_app_install_ad_app_store_pb.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStoreMap[keyof google_ads_googleads_v2_enums_legacy_app_install_ad_app_store_pb.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStoreMap]): void;
...
export namespace LegacyAppInstallAdInfo {
  export type AsObject = {
    ...
    appStore: google_ads_googleads_v2_enums_legacy_app_install_ad_app_store_pb.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStoreMap[keyof google_ads_googleads_v2_enums_legacy_app_install_ad_app_store_pb.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStoreMap],
    headline?: google_protobuf_wrappers_pb.StringValue.AsObject,
    description1?: google_protobuf_wrappers_pb.StringValue.AsObject,
    description2?: google_protobuf_wrappers_pb.StringValue.AsObject,
  }
...
export class DisplayUploadAdInfo extends jspb.Message {
  getDisplayUploadProductType(): google_ads_googleads_v2_enums_display_upload_product_type_pb.DisplayUploadProductTypeEnum.DisplayUploadProductTypeMap[keyof google_ads_googleads_v2_enums_display_upload_product_type_pb.DisplayUploadProductTypeEnum.DisplayUploadProductTypeMap];
  setDisplayUploadProductType(value: google_ads_googleads_v2_enums_display_upload_product_type_pb.DisplayUploadProductTypeEnum.DisplayUploadProductTypeMap[keyof google_ads_googleads_v2_enums_display_upload_product_type_pb.DisplayUploadProductTypeEnum.DisplayUploadProductTypeMap]): void;
...
export namespace DisplayUploadAdInfo {
  export type AsObject = {
    displayUploadProductType: google_ads_googleads_v2_enums_display_upload_product_type_pb.DisplayUploadProductTypeEnum.DisplayUploadProductTypeMap[keyof google_ads_googleads_v2_enums_display_upload_product_type_pb.DisplayUploadProductTypeEnum.DisplayUploadProductTypeMap],
