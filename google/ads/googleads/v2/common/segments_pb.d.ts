...
export class Segments extends jspb.Message {
  getAdNetworkType(): google_ads_googleads_v2_enums_ad_network_type_pb.AdNetworkTypeEnum.AdNetworkTypeMap[keyof google_ads_googleads_v2_enums_ad_network_type_pb.AdNetworkTypeEnum.AdNetworkTypeMap];
  setAdNetworkType(value: google_ads_googleads_v2_enums_ad_network_type_pb.AdNetworkTypeEnum.AdNetworkTypeMap[keyof google_ads_googleads_v2_enums_ad_network_type_pb.AdNetworkTypeEnum.AdNetworkTypeMap]): void;

  getClickType(): google_ads_googleads_v2_enums_click_type_pb.ClickTypeEnum.ClickTypeMap[keyof google_ads_googleads_v2_enums_click_type_pb.ClickTypeEnum.ClickTypeMap];
  setClickType(value: google_ads_googleads_v2_enums_click_type_pb.ClickTypeEnum.ClickTypeMap[keyof google_ads_googleads_v2_enums_click_type_pb.ClickTypeEnum.ClickTypeMap]): void;
  ...
  getConversionActionCategory(): google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap[keyof google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap];
  setConversionActionCategory(value: google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap[keyof google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap]): void;
  ...
  getConversionAttributionEventType(): google_ads_googleads_v2_enums_conversion_attribution_event_type_pb.ConversionAttributionEventTypeEnum.ConversionAttributionEventTypeMap[keyof google_ads_googleads_v2_enums_conversion_attribution_event_type_pb.ConversionAttributionEventTypeEnum.ConversionAttributionEventTypeMap];
  setConversionAttributionEventType(value: google_ads_googleads_v2_enums_conversion_attribution_event_type_pb.ConversionAttributionEventTypeEnum.ConversionAttributionEventTypeMap[keyof google_ads_googleads_v2_enums_conversion_attribution_event_type_pb.ConversionAttributionEventTypeEnum.ConversionAttributionEventTypeMap]): void;

  getConversionLagBucket(): google_ads_googleads_v2_enums_conversion_lag_bucket_pb.ConversionLagBucketEnum.ConversionLagBucketMap[keyof google_ads_googleads_v2_enums_conversion_lag_bucket_pb.ConversionLagBucketEnum.ConversionLagBucketMap];
  setConversionLagBucket(value: google_ads_googleads_v2_enums_conversion_lag_bucket_pb.ConversionLagBucketEnum.ConversionLagBucketMap[keyof google_ads_googleads_v2_enums_conversion_lag_bucket_pb.ConversionLagBucketEnum.ConversionLagBucketMap]): void;

  getConversionOrAdjustmentLagBucket(): google_ads_googleads_v2_enums_conversion_or_adjustment_lag_bucket_pb.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucketMap[keyof google_ads_googleads_v2_enums_conversion_or_adjustment_lag_bucket_pb.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucketMap];
  setConversionOrAdjustmentLagBucket(value: google_ads_googleads_v2_enums_conversion_or_adjustment_lag_bucket_pb.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucketMap[keyof google_ads_googleads_v2_enums_conversion_or_adjustment_lag_bucket_pb.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucketMap]): void;
  ...
  getDevice(): google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap[keyof google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap];
  setDevice(value: google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap[keyof google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap]): void;

  getExternalConversionSource(): google_ads_googleads_v2_enums_external_conversion_source_pb.ExternalConversionSourceEnum.ExternalConversionSourceMap[keyof google_ads_googleads_v2_enums_external_conversion_source_pb.ExternalConversionSourceEnum.ExternalConversionSourceMap];
  setExternalConversionSource(value: google_ads_googleads_v2_enums_external_conversion_source_pb.ExternalConversionSourceEnum.ExternalConversionSourceMap[keyof google_ads_googleads_v2_enums_external_conversion_source_pb.ExternalConversionSourceEnum.ExternalConversionSourceMap]): void;
  ...
  getHotelCheckInDayOfWeek(): google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap[keyof google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap];
  setHotelCheckInDayOfWeek(value: google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap[keyof google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap]): void;
  ...
  getHotelDateSelectionType(): google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap[keyof google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap];
  setHotelDateSelectionType(value: google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap[keyof google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap]): void;
  ...
  getHotelRateType(): google_ads_googleads_v2_enums_hotel_rate_type_pb.HotelRateTypeEnum.HotelRateTypeMap[keyof google_ads_googleads_v2_enums_hotel_rate_type_pb.HotelRateTypeEnum.HotelRateTypeMap];
  setHotelRateType(value: google_ads_googleads_v2_enums_hotel_rate_type_pb.HotelRateTypeEnum.HotelRateTypeMap[keyof google_ads_googleads_v2_enums_hotel_rate_type_pb.HotelRateTypeEnum.HotelRateTypeMap]): void;

  getHotelPriceBucket(): google_ads_googleads_v2_enums_hotel_price_bucket_pb.HotelPriceBucketEnum.HotelPriceBucketMap[keyof google_ads_googleads_v2_enums_hotel_price_bucket_pb.HotelPriceBucketEnum.HotelPriceBucketMap];
  setHotelPriceBucket(value: google_ads_googleads_v2_enums_hotel_price_bucket_pb.HotelPriceBucketEnum.HotelPriceBucketMap[keyof google_ads_googleads_v2_enums_hotel_price_bucket_pb.HotelPriceBucketEnum.HotelPriceBucketMap]): void;
  ...
  getMonthOfYear(): google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap[keyof google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap];
  setMonthOfYear(value: google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap[keyof google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap]): void;
  ...
  getProductChannel(): google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap[keyof google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap];
  setProductChannel(value: google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap[keyof google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap]): void;

  getProductChannelExclusivity(): google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap[keyof google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap];
  setProductChannelExclusivity(value: google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap[keyof google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap]): void;

  getProductCondition(): google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap[keyof google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap];
  setProductCondition(value: google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap[keyof google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap]): void;
  ...
  getSearchEngineResultsPageType(): google_ads_googleads_v2_enums_search_engine_results_page_type_pb.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageTypeMap[keyof google_ads_googleads_v2_enums_search_engine_results_page_type_pb.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageTypeMap];
  setSearchEngineResultsPageType(value: google_ads_googleads_v2_enums_search_engine_results_page_type_pb.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageTypeMap[keyof google_ads_googleads_v2_enums_search_engine_results_page_type_pb.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageTypeMap]): void;

  getSearchTermMatchType(): google_ads_googleads_v2_enums_search_term_match_type_pb.SearchTermMatchTypeEnum.SearchTermMatchTypeMap[keyof google_ads_googleads_v2_enums_search_term_match_type_pb.SearchTermMatchTypeEnum.SearchTermMatchTypeMap];
  setSearchTermMatchType(value: google_ads_googleads_v2_enums_search_term_match_type_pb.SearchTermMatchTypeEnum.SearchTermMatchTypeMap[keyof google_ads_googleads_v2_enums_search_term_match_type_pb.SearchTermMatchTypeEnum.SearchTermMatchTypeMap]): void;

  getSlot(): google_ads_googleads_v2_enums_slot_pb.SlotEnum.SlotMap[keyof google_ads_googleads_v2_enums_slot_pb.SlotEnum.SlotMap];
  setSlot(value: google_ads_googleads_v2_enums_slot_pb.SlotEnum.SlotMap[keyof google_ads_googleads_v2_enums_slot_pb.SlotEnum.SlotMap]): void;
...
export namespace Segments {
  export type AsObject = {
    adNetworkType: google_ads_googleads_v2_enums_ad_network_type_pb.AdNetworkTypeEnum.AdNetworkTypeMap[keyof google_ads_googleads_v2_enums_ad_network_type_pb.AdNetworkTypeEnum.AdNetworkTypeMap],
    clickType: google_ads_googleads_v2_enums_click_type_pb.ClickTypeEnum.ClickTypeMap[keyof google_ads_googleads_v2_enums_click_type_pb.ClickTypeEnum.ClickTypeMap],
    conversionAction?: google_protobuf_wrappers_pb.StringValue.AsObject,
    conversionActionCategory: google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap[keyof google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap],
    ...
    conversionAttributionEventType: google_ads_googleads_v2_enums_conversion_attribution_event_type_pb.ConversionAttributionEventTypeEnum.ConversionAttributionEventTypeMap[keyof google_ads_googleads_v2_enums_conversion_attribution_event_type_pb.ConversionAttributionEventTypeEnum.ConversionAttributionEventTypeMap],
    conversionLagBucket: google_ads_googleads_v2_enums_conversion_lag_bucket_pb.ConversionLagBucketEnum.ConversionLagBucketMap[keyof google_ads_googleads_v2_enums_conversion_lag_bucket_pb.ConversionLagBucketEnum.ConversionLagBucketMap],
    conversionOrAdjustmentLagBucket: google_ads_googleads_v2_enums_conversion_or_adjustment_lag_bucket_pb.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucketMap[keyof google_ads_googleads_v2_enums_conversion_or_adjustment_lag_bucket_pb.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucketMap],
    ...
    device: google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap[keyof google_ads_googleads_v2_enums_device_pb.DeviceEnum.DeviceMap],
    externalConversionSource: google_ads_googleads_v2_enums_external_conversion_source_pb.ExternalConversionSourceEnum.ExternalConversionSourceMap[keyof google_ads_googleads_v2_enums_external_conversion_source_pb.ExternalConversionSourceEnum.ExternalConversionSourceMap],
    ...
    hotelCheckInDayOfWeek: google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap[keyof google_ads_googleads_v2_enums_day_of_week_pb.DayOfWeekEnum.DayOfWeekMap],
    ...
    hotelDateSelectionType: google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap[keyof google_ads_googleads_v2_enums_hotel_date_selection_type_pb.HotelDateSelectionTypeEnum.HotelDateSelectionTypeMap],
    ...
    hotelRateType: google_ads_googleads_v2_enums_hotel_rate_type_pb.HotelRateTypeEnum.HotelRateTypeMap[keyof google_ads_googleads_v2_enums_hotel_rate_type_pb.HotelRateTypeEnum.HotelRateTypeMap],
    hotelPriceBucket: google_ads_googleads_v2_enums_hotel_price_bucket_pb.HotelPriceBucketEnum.HotelPriceBucketMap[keyof google_ads_googleads_v2_enums_hotel_price_bucket_pb.HotelPriceBucketEnum.HotelPriceBucketMap],
    ...
    monthOfYear: google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap[keyof google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap],
    ...
    productChannel: google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap[keyof google_ads_googleads_v2_enums_product_channel_pb.ProductChannelEnum.ProductChannelMap],
    productChannelExclusivity: google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap[keyof google_ads_googleads_v2_enums_product_channel_exclusivity_pb.ProductChannelExclusivityEnum.ProductChannelExclusivityMap],
    productCondition: google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap[keyof google_ads_googleads_v2_enums_product_condition_pb.ProductConditionEnum.ProductConditionMap],
    ...
    searchEngineResultsPageType: google_ads_googleads_v2_enums_search_engine_results_page_type_pb.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageTypeMap[keyof google_ads_googleads_v2_enums_search_engine_results_page_type_pb.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageTypeMap],
    searchTermMatchType: google_ads_googleads_v2_enums_search_term_match_type_pb.SearchTermMatchTypeEnum.SearchTermMatchTypeMap[keyof google_ads_googleads_v2_enums_search_term_match_type_pb.SearchTermMatchTypeEnum.SearchTermMatchTypeMap],
    slot: google_ads_googleads_v2_enums_slot_pb.SlotEnum.SlotMap[keyof google_ads_googleads_v2_enums_slot_pb.SlotEnum.SlotMap],
