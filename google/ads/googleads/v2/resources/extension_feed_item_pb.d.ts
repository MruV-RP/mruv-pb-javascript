...
export class ExtensionFeedItem extends jspb.Message {
  ...
  getExtensionType(): google_ads_googleads_v2_enums_extension_type_pb.ExtensionTypeEnum.ExtensionTypeMap[keyof google_ads_googleads_v2_enums_extension_type_pb.ExtensionTypeEnum.ExtensionTypeMap];
  setExtensionType(value: google_ads_googleads_v2_enums_extension_type_pb.ExtensionTypeEnum.ExtensionTypeMap[keyof google_ads_googleads_v2_enums_extension_type_pb.ExtensionTypeEnum.ExtensionTypeMap]): void;
  ...
  getDevice(): google_ads_googleads_v2_enums_feed_item_target_device_pb.FeedItemTargetDeviceEnum.FeedItemTargetDeviceMap[keyof google_ads_googleads_v2_enums_feed_item_target_device_pb.FeedItemTargetDeviceEnum.FeedItemTargetDeviceMap];
  setDevice(value: google_ads_googleads_v2_enums_feed_item_target_device_pb.FeedItemTargetDeviceEnum.FeedItemTargetDeviceMap[keyof google_ads_googleads_v2_enums_feed_item_target_device_pb.FeedItemTargetDeviceEnum.FeedItemTargetDeviceMap]): void;
...
export namespace ExtensionFeedItem {
  export type AsObject = {
    ...
    extensionType: google_ads_googleads_v2_enums_extension_type_pb.ExtensionTypeEnum.ExtensionTypeMap[keyof google_ads_googleads_v2_enums_extension_type_pb.ExtensionTypeEnum.ExtensionTypeMap],
    ...
    device: google_ads_googleads_v2_enums_feed_item_target_device_pb.FeedItemTargetDeviceEnum.FeedItemTargetDeviceMap[keyof google_ads_googleads_v2_enums_feed_item_target_device_pb.FeedItemTargetDeviceEnum.FeedItemTargetDeviceMap],
