...
export class OperatingSystemVersionConstant extends jspb.Message {
  ...
  getOperatorType(): google_ads_googleads_v2_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap[keyof google_ads_googleads_v2_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap];
  setOperatorType(value: google_ads_googleads_v2_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap[keyof google_ads_googleads_v2_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap]): void;
...
export namespace OperatingSystemVersionConstant {
  export type AsObject = {
    ...
    operatorType: google_ads_googleads_v2_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap[keyof google_ads_googleads_v2_enums_operating_system_version_operator_type_pb.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorTypeMap],
  }
}
