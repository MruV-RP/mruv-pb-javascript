...
export class BiddingStrategy extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v2_enums_bidding_strategy_status_pb.BiddingStrategyStatusEnum.BiddingStrategyStatusMap[keyof google_ads_googleads_v2_enums_bidding_strategy_status_pb.BiddingStrategyStatusEnum.BiddingStrategyStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_bidding_strategy_status_pb.BiddingStrategyStatusEnum.BiddingStrategyStatusMap[keyof google_ads_googleads_v2_enums_bidding_strategy_status_pb.BiddingStrategyStatusEnum.BiddingStrategyStatusMap]): void;

  getType(): google_ads_googleads_v2_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap[keyof google_ads_googleads_v2_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap];
  setType(value: google_ads_googleads_v2_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap[keyof google_ads_googleads_v2_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap]): void;
...
export namespace BiddingStrategy {
  export type AsObject = {
    ...
    status: google_ads_googleads_v2_enums_bidding_strategy_status_pb.BiddingStrategyStatusEnum.BiddingStrategyStatusMap[keyof google_ads_googleads_v2_enums_bidding_strategy_status_pb.BiddingStrategyStatusEnum.BiddingStrategyStatusMap],
    type: google_ads_googleads_v2_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap[keyof google_ads_googleads_v2_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap],
