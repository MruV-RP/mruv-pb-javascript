...
export class CampaignCriterionSimulation extends jspb.Message {
  ...
  getType(): google_ads_googleads_v2_enums_simulation_type_pb.SimulationTypeEnum.SimulationTypeMap[keyof google_ads_googleads_v2_enums_simulation_type_pb.SimulationTypeEnum.SimulationTypeMap];
  setType(value: google_ads_googleads_v2_enums_simulation_type_pb.SimulationTypeEnum.SimulationTypeMap[keyof google_ads_googleads_v2_enums_simulation_type_pb.SimulationTypeEnum.SimulationTypeMap]): void;

  getModificationMethod(): google_ads_googleads_v2_enums_simulation_modification_method_pb.SimulationModificationMethodEnum.SimulationModificationMethodMap[keyof google_ads_googleads_v2_enums_simulation_modification_method_pb.SimulationModificationMethodEnum.SimulationModificationMethodMap];
  setModificationMethod(value: google_ads_googleads_v2_enums_simulation_modification_method_pb.SimulationModificationMethodEnum.SimulationModificationMethodMap[keyof google_ads_googleads_v2_enums_simulation_modification_method_pb.SimulationModificationMethodEnum.SimulationModificationMethodMap]): void;
...
export namespace CampaignCriterionSimulation {
  export type AsObject = {
    ...
    type: google_ads_googleads_v2_enums_simulation_type_pb.SimulationTypeEnum.SimulationTypeMap[keyof google_ads_googleads_v2_enums_simulation_type_pb.SimulationTypeEnum.SimulationTypeMap],
    modificationMethod: google_ads_googleads_v2_enums_simulation_modification_method_pb.SimulationModificationMethodEnum.SimulationModificationMethodMap[keyof google_ads_googleads_v2_enums_simulation_modification_method_pb.SimulationModificationMethodEnum.SimulationModificationMethodMap],
