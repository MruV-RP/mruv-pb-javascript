...
export class Recommendation extends jspb.Message {
  ...
  getType(): google_ads_googleads_v2_enums_recommendation_type_pb.RecommendationTypeEnum.RecommendationTypeMap[keyof google_ads_googleads_v2_enums_recommendation_type_pb.RecommendationTypeEnum.RecommendationTypeMap];
  setType(value: google_ads_googleads_v2_enums_recommendation_type_pb.RecommendationTypeEnum.RecommendationTypeMap[keyof google_ads_googleads_v2_enums_recommendation_type_pb.RecommendationTypeEnum.RecommendationTypeMap]): void;
...
export namespace Recommendation {
  export type AsObject = {
    resourceName: string,
    type: google_ads_googleads_v2_enums_recommendation_type_pb.RecommendationTypeEnum.RecommendationTypeMap[keyof google_ads_googleads_v2_enums_recommendation_type_pb.RecommendationTypeEnum.RecommendationTypeMap],
  ...
  export namespace TargetCpaOptInRecommendation {
    ...
    export class TargetCpaOptInRecommendationOption extends jspb.Message {
      getGoal(): google_ads_googleads_v2_enums_target_cpa_opt_in_recommendation_goal_pb.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoalMap[keyof google_ads_googleads_v2_enums_target_cpa_opt_in_recommendation_goal_pb.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoalMap];
      setGoal(value: google_ads_googleads_v2_enums_target_cpa_opt_in_recommendation_goal_pb.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoalMap[keyof google_ads_googleads_v2_enums_target_cpa_opt_in_recommendation_goal_pb.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoalMap]): void;
    ...
    export namespace TargetCpaOptInRecommendationOption {
      export type AsObject = {
        goal: google_ads_googleads_v2_enums_target_cpa_opt_in_recommendation_goal_pb.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoalMap[keyof google_ads_googleads_v2_enums_target_cpa_opt_in_recommendation_goal_pb.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoalMap],
  ...
  export class KeywordMatchTypeRecommendation extends jspb.Message {
    ...
    getRecommendedMatchType(): google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap[keyof google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap];
    setRecommendedMatchType(value: google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap[keyof google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap]): void;
  ...
  export namespace KeywordMatchTypeRecommendation {
    export type AsObject = {
      keyword?: google_ads_googleads_v2_common_criteria_pb.KeywordInfo.AsObject,
      recommendedMatchType: google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap[keyof google_ads_googleads_v2_enums_keyword_match_type_pb.KeywordMatchTypeEnum.KeywordMatchTypeMap],
    }
  }
