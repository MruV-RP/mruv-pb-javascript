...
export class MobileDeviceConstant extends jspb.Message {
  ...
  getType(): google_ads_googleads_v2_enums_mobile_device_type_pb.MobileDeviceTypeEnum.MobileDeviceTypeMap[keyof google_ads_googleads_v2_enums_mobile_device_type_pb.MobileDeviceTypeEnum.MobileDeviceTypeMap];
  setType(value: google_ads_googleads_v2_enums_mobile_device_type_pb.MobileDeviceTypeEnum.MobileDeviceTypeMap[keyof google_ads_googleads_v2_enums_mobile_device_type_pb.MobileDeviceTypeEnum.MobileDeviceTypeMap]): void;
...
export namespace MobileDeviceConstant {
  export type AsObject = {
    ...
    type: google_ads_googleads_v2_enums_mobile_device_type_pb.MobileDeviceTypeEnum.MobileDeviceTypeMap[keyof google_ads_googleads_v2_enums_mobile_device_type_pb.MobileDeviceTypeEnum.MobileDeviceTypeMap],
  }
}
