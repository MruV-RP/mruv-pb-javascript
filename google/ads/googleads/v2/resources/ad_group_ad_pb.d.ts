...
export class AdGroupAd extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v2_enums_ad_group_ad_status_pb.AdGroupAdStatusEnum.AdGroupAdStatusMap[keyof google_ads_googleads_v2_enums_ad_group_ad_status_pb.AdGroupAdStatusEnum.AdGroupAdStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_ad_group_ad_status_pb.AdGroupAdStatusEnum.AdGroupAdStatusMap[keyof google_ads_googleads_v2_enums_ad_group_ad_status_pb.AdGroupAdStatusEnum.AdGroupAdStatusMap]): void;
  ...
  getAdStrength(): google_ads_googleads_v2_enums_ad_strength_pb.AdStrengthEnum.AdStrengthMap[keyof google_ads_googleads_v2_enums_ad_strength_pb.AdStrengthEnum.AdStrengthMap];
  setAdStrength(value: google_ads_googleads_v2_enums_ad_strength_pb.AdStrengthEnum.AdStrengthMap[keyof google_ads_googleads_v2_enums_ad_strength_pb.AdStrengthEnum.AdStrengthMap]): void;
...
export namespace AdGroupAd {
  export type AsObject = {
    resourceName: string,
    status: google_ads_googleads_v2_enums_ad_group_ad_status_pb.AdGroupAdStatusEnum.AdGroupAdStatusMap[keyof google_ads_googleads_v2_enums_ad_group_ad_status_pb.AdGroupAdStatusEnum.AdGroupAdStatusMap],
    ...
    adStrength: google_ads_googleads_v2_enums_ad_strength_pb.AdStrengthEnum.AdStrengthMap[keyof google_ads_googleads_v2_enums_ad_strength_pb.AdStrengthEnum.AdStrengthMap],
  }
}
