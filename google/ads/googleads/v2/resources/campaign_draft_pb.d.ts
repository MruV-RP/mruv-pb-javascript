...
export class CampaignDraft extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v2_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap[keyof google_ads_googleads_v2_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap[keyof google_ads_googleads_v2_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap]): void;
...
export namespace CampaignDraft {
  export type AsObject = {
    ...
    status: google_ads_googleads_v2_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap[keyof google_ads_googleads_v2_enums_campaign_draft_status_pb.CampaignDraftStatusEnum.CampaignDraftStatusMap],
