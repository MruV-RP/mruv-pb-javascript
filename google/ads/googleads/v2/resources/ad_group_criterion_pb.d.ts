...
export class AdGroupCriterion extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v2_enums_ad_group_criterion_status_pb.AdGroupCriterionStatusEnum.AdGroupCriterionStatusMap[keyof google_ads_googleads_v2_enums_ad_group_criterion_status_pb.AdGroupCriterionStatusEnum.AdGroupCriterionStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_ad_group_criterion_status_pb.AdGroupCriterionStatusEnum.AdGroupCriterionStatusMap[keyof google_ads_googleads_v2_enums_ad_group_criterion_status_pb.AdGroupCriterionStatusEnum.AdGroupCriterionStatusMap]): void;
  ...
  getType(): google_ads_googleads_v2_enums_criterion_type_pb.CriterionTypeEnum.CriterionTypeMap[keyof google_ads_googleads_v2_enums_criterion_type_pb.CriterionTypeEnum.CriterionTypeMap];
  setType(value: google_ads_googleads_v2_enums_criterion_type_pb.CriterionTypeEnum.CriterionTypeMap[keyof google_ads_googleads_v2_enums_criterion_type_pb.CriterionTypeEnum.CriterionTypeMap]): void;
  ...
  getSystemServingStatus(): google_ads_googleads_v2_enums_criterion_system_serving_status_pb.CriterionSystemServingStatusEnum.CriterionSystemServingStatusMap[keyof google_ads_googleads_v2_enums_criterion_system_serving_status_pb.CriterionSystemServingStatusEnum.CriterionSystemServingStatusMap];
  setSystemServingStatus(value: google_ads_googleads_v2_enums_criterion_system_serving_status_pb.CriterionSystemServingStatusEnum.CriterionSystemServingStatusMap[keyof google_ads_googleads_v2_enums_criterion_system_serving_status_pb.CriterionSystemServingStatusEnum.CriterionSystemServingStatusMap]): void;

  getApprovalStatus(): google_ads_googleads_v2_enums_ad_group_criterion_approval_status_pb.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatusMap[keyof google_ads_googleads_v2_enums_ad_group_criterion_approval_status_pb.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatusMap];
  setApprovalStatus(value: google_ads_googleads_v2_enums_ad_group_criterion_approval_status_pb.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatusMap[keyof google_ads_googleads_v2_enums_ad_group_criterion_approval_status_pb.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatusMap]): void;
  ...
  getEffectiveCpcBidSource(): google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap];
  setEffectiveCpcBidSource(value: google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap]): void;

  getEffectiveCpmBidSource(): google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap];
  setEffectiveCpmBidSource(value: google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap]): void;

  getEffectiveCpvBidSource(): google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap];
  setEffectiveCpvBidSource(value: google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap]): void;

  getEffectivePercentCpcBidSource(): google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap];
  setEffectivePercentCpcBidSource(value: google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap]): void;
...
export namespace AdGroupCriterion {
  export type AsObject = {
    ...
    status: google_ads_googleads_v2_enums_ad_group_criterion_status_pb.AdGroupCriterionStatusEnum.AdGroupCriterionStatusMap[keyof google_ads_googleads_v2_enums_ad_group_criterion_status_pb.AdGroupCriterionStatusEnum.AdGroupCriterionStatusMap],
    qualityInfo?: AdGroupCriterion.QualityInfo.AsObject,
    adGroup?: google_protobuf_wrappers_pb.StringValue.AsObject,
    type: google_ads_googleads_v2_enums_criterion_type_pb.CriterionTypeEnum.CriterionTypeMap[keyof google_ads_googleads_v2_enums_criterion_type_pb.CriterionTypeEnum.CriterionTypeMap],
    negative?: google_protobuf_wrappers_pb.BoolValue.AsObject,
    systemServingStatus: google_ads_googleads_v2_enums_criterion_system_serving_status_pb.CriterionSystemServingStatusEnum.CriterionSystemServingStatusMap[keyof google_ads_googleads_v2_enums_criterion_system_serving_status_pb.CriterionSystemServingStatusEnum.CriterionSystemServingStatusMap],
    approvalStatus: google_ads_googleads_v2_enums_ad_group_criterion_approval_status_pb.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatusMap[keyof google_ads_googleads_v2_enums_ad_group_criterion_approval_status_pb.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatusMap],
    ...
    effectiveCpcBidSource: google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap],
    effectiveCpmBidSource: google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap],
    effectiveCpvBidSource: google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap],
    effectivePercentCpcBidSource: google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap[keyof google_ads_googleads_v2_enums_bidding_source_pb.BiddingSourceEnum.BiddingSourceMap],
  ...
  export class QualityInfo extends jspb.Message {
    ...
    getCreativeQualityScore(): google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap];
    setCreativeQualityScore(value: google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap]): void;

    getPostClickQualityScore(): google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap];
    setPostClickQualityScore(value: google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap]): void;

    getSearchPredictedCtr(): google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap];
    setSearchPredictedCtr(value: google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap]): void;
  ...
  export namespace QualityInfo {
    export type AsObject = {
      ...
      creativeQualityScore: google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap],
      postClickQualityScore: google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap],
      searchPredictedCtr: google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap[keyof google_ads_googleads_v2_enums_quality_score_bucket_pb.QualityScoreBucketEnum.QualityScoreBucketMap],
    }
  }
