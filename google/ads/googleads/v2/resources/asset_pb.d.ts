...
export class Asset extends jspb.Message {
  ...
  getType(): google_ads_googleads_v2_enums_asset_type_pb.AssetTypeEnum.AssetTypeMap[keyof google_ads_googleads_v2_enums_asset_type_pb.AssetTypeEnum.AssetTypeMap];
  setType(value: google_ads_googleads_v2_enums_asset_type_pb.AssetTypeEnum.AssetTypeMap[keyof google_ads_googleads_v2_enums_asset_type_pb.AssetTypeEnum.AssetTypeMap]): void;
...
export namespace Asset {
  export type AsObject = {
    ...
    type: google_ads_googleads_v2_enums_asset_type_pb.AssetTypeEnum.AssetTypeMap[keyof google_ads_googleads_v2_enums_asset_type_pb.AssetTypeEnum.AssetTypeMap],
