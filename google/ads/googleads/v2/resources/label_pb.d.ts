...
export class Label extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v2_enums_label_status_pb.LabelStatusEnum.LabelStatusMap[keyof google_ads_googleads_v2_enums_label_status_pb.LabelStatusEnum.LabelStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_label_status_pb.LabelStatusEnum.LabelStatusMap[keyof google_ads_googleads_v2_enums_label_status_pb.LabelStatusEnum.LabelStatusMap]): void;
...
export namespace Label {
  export type AsObject = {
    ...
    status: google_ads_googleads_v2_enums_label_status_pb.LabelStatusEnum.LabelStatusMap[keyof google_ads_googleads_v2_enums_label_status_pb.LabelStatusEnum.LabelStatusMap],
