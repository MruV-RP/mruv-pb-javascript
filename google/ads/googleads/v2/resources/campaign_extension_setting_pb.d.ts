...
export class CampaignExtensionSetting extends jspb.Message {
  ...
  getDevice(): google_ads_googleads_v2_enums_extension_setting_device_pb.ExtensionSettingDeviceEnum.ExtensionSettingDeviceMap[keyof google_ads_googleads_v2_enums_extension_setting_device_pb.ExtensionSettingDeviceEnum.ExtensionSettingDeviceMap];
  setDevice(value: google_ads_googleads_v2_enums_extension_setting_device_pb.ExtensionSettingDeviceEnum.ExtensionSettingDeviceMap[keyof google_ads_googleads_v2_enums_extension_setting_device_pb.ExtensionSettingDeviceEnum.ExtensionSettingDeviceMap]): void;
...
export namespace CampaignExtensionSetting {
  export type AsObject = {
    ...
    device: google_ads_googleads_v2_enums_extension_setting_device_pb.ExtensionSettingDeviceEnum.ExtensionSettingDeviceMap[keyof google_ads_googleads_v2_enums_extension_setting_device_pb.ExtensionSettingDeviceEnum.ExtensionSettingDeviceMap],
  }
}
