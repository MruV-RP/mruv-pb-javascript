...
export class SharedSet extends jspb.Message {
  ...
  getType(): google_ads_googleads_v2_enums_shared_set_type_pb.SharedSetTypeEnum.SharedSetTypeMap[keyof google_ads_googleads_v2_enums_shared_set_type_pb.SharedSetTypeEnum.SharedSetTypeMap];
  setType(value: google_ads_googleads_v2_enums_shared_set_type_pb.SharedSetTypeEnum.SharedSetTypeMap[keyof google_ads_googleads_v2_enums_shared_set_type_pb.SharedSetTypeEnum.SharedSetTypeMap]): void;
  ...
  getStatus(): google_ads_googleads_v2_enums_shared_set_status_pb.SharedSetStatusEnum.SharedSetStatusMap[keyof google_ads_googleads_v2_enums_shared_set_status_pb.SharedSetStatusEnum.SharedSetStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_shared_set_status_pb.SharedSetStatusEnum.SharedSetStatusMap[keyof google_ads_googleads_v2_enums_shared_set_status_pb.SharedSetStatusEnum.SharedSetStatusMap]): void;
...
export namespace SharedSet {
  export type AsObject = {
    ...
    type: google_ads_googleads_v2_enums_shared_set_type_pb.SharedSetTypeEnum.SharedSetTypeMap[keyof google_ads_googleads_v2_enums_shared_set_type_pb.SharedSetTypeEnum.SharedSetTypeMap],
    name?: google_protobuf_wrappers_pb.StringValue.AsObject,
    status: google_ads_googleads_v2_enums_shared_set_status_pb.SharedSetStatusEnum.SharedSetStatusMap[keyof google_ads_googleads_v2_enums_shared_set_status_pb.SharedSetStatusEnum.SharedSetStatusMap],
