...
export class AdGroupAdAssetView extends jspb.Message {
  ...
  getFieldType(): google_ads_googleads_v2_enums_asset_field_type_pb.AssetFieldTypeEnum.AssetFieldTypeMap[keyof google_ads_googleads_v2_enums_asset_field_type_pb.AssetFieldTypeEnum.AssetFieldTypeMap];
  setFieldType(value: google_ads_googleads_v2_enums_asset_field_type_pb.AssetFieldTypeEnum.AssetFieldTypeMap[keyof google_ads_googleads_v2_enums_asset_field_type_pb.AssetFieldTypeEnum.AssetFieldTypeMap]): void;
  ...
  getPerformanceLabel(): google_ads_googleads_v2_enums_asset_performance_label_pb.AssetPerformanceLabelEnum.AssetPerformanceLabelMap[keyof google_ads_googleads_v2_enums_asset_performance_label_pb.AssetPerformanceLabelEnum.AssetPerformanceLabelMap];
  setPerformanceLabel(value: google_ads_googleads_v2_enums_asset_performance_label_pb.AssetPerformanceLabelEnum.AssetPerformanceLabelMap[keyof google_ads_googleads_v2_enums_asset_performance_label_pb.AssetPerformanceLabelEnum.AssetPerformanceLabelMap]): void;
...
export namespace AdGroupAdAssetView {
  export type AsObject = {
    ...
    fieldType: google_ads_googleads_v2_enums_asset_field_type_pb.AssetFieldTypeEnum.AssetFieldTypeMap[keyof google_ads_googleads_v2_enums_asset_field_type_pb.AssetFieldTypeEnum.AssetFieldTypeMap],
    policySummary?: AdGroupAdAssetPolicySummary.AsObject,
    performanceLabel: google_ads_googleads_v2_enums_asset_performance_label_pb.AssetPerformanceLabelEnum.AssetPerformanceLabelMap[keyof google_ads_googleads_v2_enums_asset_performance_label_pb.AssetPerformanceLabelEnum.AssetPerformanceLabelMap],
  }
}
