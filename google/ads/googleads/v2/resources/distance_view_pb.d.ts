...
export class DistanceView extends jspb.Message {
  ...
  getDistanceBucket(): google_ads_googleads_v2_enums_distance_bucket_pb.DistanceBucketEnum.DistanceBucketMap[keyof google_ads_googleads_v2_enums_distance_bucket_pb.DistanceBucketEnum.DistanceBucketMap];
  setDistanceBucket(value: google_ads_googleads_v2_enums_distance_bucket_pb.DistanceBucketEnum.DistanceBucketMap[keyof google_ads_googleads_v2_enums_distance_bucket_pb.DistanceBucketEnum.DistanceBucketMap]): void;
...
export namespace DistanceView {
  export type AsObject = {
    resourceName: string,
    distanceBucket: google_ads_googleads_v2_enums_distance_bucket_pb.DistanceBucketEnum.DistanceBucketMap[keyof google_ads_googleads_v2_enums_distance_bucket_pb.DistanceBucketEnum.DistanceBucketMap],
