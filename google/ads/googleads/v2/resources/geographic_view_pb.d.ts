...
export class GeographicView extends jspb.Message {
  ...
  getLocationType(): google_ads_googleads_v2_enums_geo_targeting_type_pb.GeoTargetingTypeEnum.GeoTargetingTypeMap[keyof google_ads_googleads_v2_enums_geo_targeting_type_pb.GeoTargetingTypeEnum.GeoTargetingTypeMap];
  setLocationType(value: google_ads_googleads_v2_enums_geo_targeting_type_pb.GeoTargetingTypeEnum.GeoTargetingTypeMap[keyof google_ads_googleads_v2_enums_geo_targeting_type_pb.GeoTargetingTypeEnum.GeoTargetingTypeMap]): void;
...
export namespace GeographicView {
  export type AsObject = {
    resourceName: string,
    locationType: google_ads_googleads_v2_enums_geo_targeting_type_pb.GeoTargetingTypeEnum.GeoTargetingTypeMap[keyof google_ads_googleads_v2_enums_geo_targeting_type_pb.GeoTargetingTypeEnum.GeoTargetingTypeMap],
