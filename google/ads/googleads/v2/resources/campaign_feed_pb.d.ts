...
export class CampaignFeed extends jspb.Message {
  ...
  getPlaceholderTypesList(): Array<google_ads_googleads_v2_enums_placeholder_type_pb.PlaceholderTypeEnum.PlaceholderTypeMap[keyof google_ads_googleads_v2_enums_placeholder_type_pb.PlaceholderTypeEnum.PlaceholderTypeMap]>;
  setPlaceholderTypesList(value: Array<google_ads_googleads_v2_enums_placeholder_type_pb.PlaceholderTypeEnum.PlaceholderTypeMap[keyof google_ads_googleads_v2_enums_placeholder_type_pb.PlaceholderTypeEnum.PlaceholderTypeMap]>): void;
  addPlaceholderTypes(value: google_ads_googleads_v2_enums_placeholder_type_pb.PlaceholderTypeEnum.PlaceholderTypeMap[keyof google_ads_googleads_v2_enums_placeholder_type_pb.PlaceholderTypeEnum.PlaceholderTypeMap], index?: number): google_ads_googleads_v2_enums_placeholder_type_pb.PlaceholderTypeEnum.PlaceholderTypeMap[keyof google_ads_googleads_v2_enums_placeholder_type_pb.PlaceholderTypeEnum.PlaceholderTypeMap];
  ...
  getStatus(): google_ads_googleads_v2_enums_feed_link_status_pb.FeedLinkStatusEnum.FeedLinkStatusMap[keyof google_ads_googleads_v2_enums_feed_link_status_pb.FeedLinkStatusEnum.FeedLinkStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_feed_link_status_pb.FeedLinkStatusEnum.FeedLinkStatusMap[keyof google_ads_googleads_v2_enums_feed_link_status_pb.FeedLinkStatusEnum.FeedLinkStatusMap]): void;
...
export namespace CampaignFeed {
  export type AsObject = {
    ...
    placeholderTypesList: Array<google_ads_googleads_v2_enums_placeholder_type_pb.PlaceholderTypeEnum.PlaceholderTypeMap[keyof google_ads_googleads_v2_enums_placeholder_type_pb.PlaceholderTypeEnum.PlaceholderTypeMap]>,
    matchingFunction?: google_ads_googleads_v2_common_matching_function_pb.MatchingFunction.AsObject,
    status: google_ads_googleads_v2_enums_feed_link_status_pb.FeedLinkStatusEnum.FeedLinkStatusMap[keyof google_ads_googleads_v2_enums_feed_link_status_pb.FeedLinkStatusEnum.FeedLinkStatusMap],
  }
}
