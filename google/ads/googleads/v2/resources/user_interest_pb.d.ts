...
export class UserInterest extends jspb.Message {
  ...
  getTaxonomyType(): google_ads_googleads_v2_enums_user_interest_taxonomy_type_pb.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyTypeMap[keyof google_ads_googleads_v2_enums_user_interest_taxonomy_type_pb.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyTypeMap];
  setTaxonomyType(value: google_ads_googleads_v2_enums_user_interest_taxonomy_type_pb.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyTypeMap[keyof google_ads_googleads_v2_enums_user_interest_taxonomy_type_pb.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyTypeMap]): void;
...
export namespace UserInterest {
  export type AsObject = {
    resourceName: string,
    taxonomyType: google_ads_googleads_v2_enums_user_interest_taxonomy_type_pb.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyTypeMap[keyof google_ads_googleads_v2_enums_user_interest_taxonomy_type_pb.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyTypeMap],
