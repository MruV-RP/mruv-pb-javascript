...
export class SearchTermView extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v2_enums_search_term_targeting_status_pb.SearchTermTargetingStatusEnum.SearchTermTargetingStatusMap[keyof google_ads_googleads_v2_enums_search_term_targeting_status_pb.SearchTermTargetingStatusEnum.SearchTermTargetingStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_search_term_targeting_status_pb.SearchTermTargetingStatusEnum.SearchTermTargetingStatusMap[keyof google_ads_googleads_v2_enums_search_term_targeting_status_pb.SearchTermTargetingStatusEnum.SearchTermTargetingStatusMap]): void;
...
export namespace SearchTermView {
  export type AsObject = {
    ...
    status: google_ads_googleads_v2_enums_search_term_targeting_status_pb.SearchTermTargetingStatusEnum.SearchTermTargetingStatusMap[keyof google_ads_googleads_v2_enums_search_term_targeting_status_pb.SearchTermTargetingStatusEnum.SearchTermTargetingStatusMap],
  }
}
