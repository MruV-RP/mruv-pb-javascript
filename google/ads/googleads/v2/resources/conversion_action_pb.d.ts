...
export class ConversionAction extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v2_enums_conversion_action_status_pb.ConversionActionStatusEnum.ConversionActionStatusMap[keyof google_ads_googleads_v2_enums_conversion_action_status_pb.ConversionActionStatusEnum.ConversionActionStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_conversion_action_status_pb.ConversionActionStatusEnum.ConversionActionStatusMap[keyof google_ads_googleads_v2_enums_conversion_action_status_pb.ConversionActionStatusEnum.ConversionActionStatusMap]): void;

  getType(): google_ads_googleads_v2_enums_conversion_action_type_pb.ConversionActionTypeEnum.ConversionActionTypeMap[keyof google_ads_googleads_v2_enums_conversion_action_type_pb.ConversionActionTypeEnum.ConversionActionTypeMap];
  setType(value: google_ads_googleads_v2_enums_conversion_action_type_pb.ConversionActionTypeEnum.ConversionActionTypeMap[keyof google_ads_googleads_v2_enums_conversion_action_type_pb.ConversionActionTypeEnum.ConversionActionTypeMap]): void;

  getCategory(): google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap[keyof google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap];
  setCategory(value: google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap[keyof google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap]): void;
  ...
  getCountingType(): google_ads_googleads_v2_enums_conversion_action_counting_type_pb.ConversionActionCountingTypeEnum.ConversionActionCountingTypeMap[keyof google_ads_googleads_v2_enums_conversion_action_counting_type_pb.ConversionActionCountingTypeEnum.ConversionActionCountingTypeMap];
  setCountingType(value: google_ads_googleads_v2_enums_conversion_action_counting_type_pb.ConversionActionCountingTypeEnum.ConversionActionCountingTypeMap[keyof google_ads_googleads_v2_enums_conversion_action_counting_type_pb.ConversionActionCountingTypeEnum.ConversionActionCountingTypeMap]): void;
...
export namespace ConversionAction {
  export type AsObject = {
    ...
    status: google_ads_googleads_v2_enums_conversion_action_status_pb.ConversionActionStatusEnum.ConversionActionStatusMap[keyof google_ads_googleads_v2_enums_conversion_action_status_pb.ConversionActionStatusEnum.ConversionActionStatusMap],
    type: google_ads_googleads_v2_enums_conversion_action_type_pb.ConversionActionTypeEnum.ConversionActionTypeMap[keyof google_ads_googleads_v2_enums_conversion_action_type_pb.ConversionActionTypeEnum.ConversionActionTypeMap],
    category: google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap[keyof google_ads_googleads_v2_enums_conversion_action_category_pb.ConversionActionCategoryEnum.ConversionActionCategoryMap],
    ...
    countingType: google_ads_googleads_v2_enums_conversion_action_counting_type_pb.ConversionActionCountingTypeEnum.ConversionActionCountingTypeMap[keyof google_ads_googleads_v2_enums_conversion_action_counting_type_pb.ConversionActionCountingTypeEnum.ConversionActionCountingTypeMap],
  ...
  export class AttributionModelSettings extends jspb.Message {
    getAttributionModel(): google_ads_googleads_v2_enums_attribution_model_pb.AttributionModelEnum.AttributionModelMap[keyof google_ads_googleads_v2_enums_attribution_model_pb.AttributionModelEnum.AttributionModelMap];
    setAttributionModel(value: google_ads_googleads_v2_enums_attribution_model_pb.AttributionModelEnum.AttributionModelMap[keyof google_ads_googleads_v2_enums_attribution_model_pb.AttributionModelEnum.AttributionModelMap]): void;

    getDataDrivenModelStatus(): google_ads_googleads_v2_enums_data_driven_model_status_pb.DataDrivenModelStatusEnum.DataDrivenModelStatusMap[keyof google_ads_googleads_v2_enums_data_driven_model_status_pb.DataDrivenModelStatusEnum.DataDrivenModelStatusMap];
    setDataDrivenModelStatus(value: google_ads_googleads_v2_enums_data_driven_model_status_pb.DataDrivenModelStatusEnum.DataDrivenModelStatusMap[keyof google_ads_googleads_v2_enums_data_driven_model_status_pb.DataDrivenModelStatusEnum.DataDrivenModelStatusMap]): void;
  ...
  export namespace AttributionModelSettings {
    export type AsObject = {
      attributionModel: google_ads_googleads_v2_enums_attribution_model_pb.AttributionModelEnum.AttributionModelMap[keyof google_ads_googleads_v2_enums_attribution_model_pb.AttributionModelEnum.AttributionModelMap],
      dataDrivenModelStatus: google_ads_googleads_v2_enums_data_driven_model_status_pb.DataDrivenModelStatusEnum.DataDrivenModelStatusMap[keyof google_ads_googleads_v2_enums_data_driven_model_status_pb.DataDrivenModelStatusEnum.DataDrivenModelStatusMap],
    }
  }
