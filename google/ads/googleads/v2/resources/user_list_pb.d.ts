...
export class UserList extends jspb.Message {
  ...
  getMembershipStatus(): google_ads_googleads_v2_enums_user_list_membership_status_pb.UserListMembershipStatusEnum.UserListMembershipStatusMap[keyof google_ads_googleads_v2_enums_user_list_membership_status_pb.UserListMembershipStatusEnum.UserListMembershipStatusMap];
  setMembershipStatus(value: google_ads_googleads_v2_enums_user_list_membership_status_pb.UserListMembershipStatusEnum.UserListMembershipStatusMap[keyof google_ads_googleads_v2_enums_user_list_membership_status_pb.UserListMembershipStatusEnum.UserListMembershipStatusMap]): void;
  ...
  getSizeRangeForDisplay(): google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap[keyof google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap];
  setSizeRangeForDisplay(value: google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap[keyof google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap]): void;
  ...
  getSizeRangeForSearch(): google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap[keyof google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap];
  setSizeRangeForSearch(value: google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap[keyof google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap]): void;

  getType(): google_ads_googleads_v2_enums_user_list_type_pb.UserListTypeEnum.UserListTypeMap[keyof google_ads_googleads_v2_enums_user_list_type_pb.UserListTypeEnum.UserListTypeMap];
  setType(value: google_ads_googleads_v2_enums_user_list_type_pb.UserListTypeEnum.UserListTypeMap[keyof google_ads_googleads_v2_enums_user_list_type_pb.UserListTypeEnum.UserListTypeMap]): void;

  getClosingReason(): google_ads_googleads_v2_enums_user_list_closing_reason_pb.UserListClosingReasonEnum.UserListClosingReasonMap[keyof google_ads_googleads_v2_enums_user_list_closing_reason_pb.UserListClosingReasonEnum.UserListClosingReasonMap];
  setClosingReason(value: google_ads_googleads_v2_enums_user_list_closing_reason_pb.UserListClosingReasonEnum.UserListClosingReasonMap[keyof google_ads_googleads_v2_enums_user_list_closing_reason_pb.UserListClosingReasonEnum.UserListClosingReasonMap]): void;

  getAccessReason(): google_ads_googleads_v2_enums_access_reason_pb.AccessReasonEnum.AccessReasonMap[keyof google_ads_googleads_v2_enums_access_reason_pb.AccessReasonEnum.AccessReasonMap];
  setAccessReason(value: google_ads_googleads_v2_enums_access_reason_pb.AccessReasonEnum.AccessReasonMap[keyof google_ads_googleads_v2_enums_access_reason_pb.AccessReasonEnum.AccessReasonMap]): void;

  getAccountUserListStatus(): google_ads_googleads_v2_enums_user_list_access_status_pb.UserListAccessStatusEnum.UserListAccessStatusMap[keyof google_ads_googleads_v2_enums_user_list_access_status_pb.UserListAccessStatusEnum.UserListAccessStatusMap];
  setAccountUserListStatus(value: google_ads_googleads_v2_enums_user_list_access_status_pb.UserListAccessStatusEnum.UserListAccessStatusMap[keyof google_ads_googleads_v2_enums_user_list_access_status_pb.UserListAccessStatusEnum.UserListAccessStatusMap]): void;
...
export namespace UserList {
  export type AsObject = {
    ...
    membershipStatus: google_ads_googleads_v2_enums_user_list_membership_status_pb.UserListMembershipStatusEnum.UserListMembershipStatusMap[keyof google_ads_googleads_v2_enums_user_list_membership_status_pb.UserListMembershipStatusEnum.UserListMembershipStatusMap],
    ...
    sizeRangeForDisplay: google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap[keyof google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap],
    sizeForSearch?: google_protobuf_wrappers_pb.Int64Value.AsObject,
    sizeRangeForSearch: google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap[keyof google_ads_googleads_v2_enums_user_list_size_range_pb.UserListSizeRangeEnum.UserListSizeRangeMap],
    type: google_ads_googleads_v2_enums_user_list_type_pb.UserListTypeEnum.UserListTypeMap[keyof google_ads_googleads_v2_enums_user_list_type_pb.UserListTypeEnum.UserListTypeMap],
    closingReason: google_ads_googleads_v2_enums_user_list_closing_reason_pb.UserListClosingReasonEnum.UserListClosingReasonMap[keyof google_ads_googleads_v2_enums_user_list_closing_reason_pb.UserListClosingReasonEnum.UserListClosingReasonMap],
    accessReason: google_ads_googleads_v2_enums_access_reason_pb.AccessReasonEnum.AccessReasonMap[keyof google_ads_googleads_v2_enums_access_reason_pb.AccessReasonEnum.AccessReasonMap],
    accountUserListStatus: google_ads_googleads_v2_enums_user_list_access_status_pb.UserListAccessStatusEnum.UserListAccessStatusMap[keyof google_ads_googleads_v2_enums_user_list_access_status_pb.UserListAccessStatusEnum.UserListAccessStatusMap],
