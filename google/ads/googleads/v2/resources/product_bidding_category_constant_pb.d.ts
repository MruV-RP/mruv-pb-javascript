...
export class ProductBiddingCategoryConstant extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v2_enums_product_bidding_category_status_pb.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatusMap[keyof google_ads_googleads_v2_enums_product_bidding_category_status_pb.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_product_bidding_category_status_pb.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatusMap[keyof google_ads_googleads_v2_enums_product_bidding_category_status_pb.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatusMap]): void;
...
export namespace ProductBiddingCategoryConstant {
  export type AsObject = {
    ...
    status: google_ads_googleads_v2_enums_product_bidding_category_status_pb.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatusMap[keyof google_ads_googleads_v2_enums_product_bidding_category_status_pb.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatusMap],
