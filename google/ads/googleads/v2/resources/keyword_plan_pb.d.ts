...
export class KeywordPlanForecastPeriod extends jspb.Message {
  ...
  getDateInterval(): google_ads_googleads_v2_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap[keyof google_ads_googleads_v2_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap];
  setDateInterval(value: google_ads_googleads_v2_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap[keyof google_ads_googleads_v2_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap]): void;
...
export namespace KeywordPlanForecastPeriod {
  export type AsObject = {
    dateInterval: google_ads_googleads_v2_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap[keyof google_ads_googleads_v2_enums_keyword_plan_forecast_interval_pb.KeywordPlanForecastIntervalEnum.KeywordPlanForecastIntervalMap],
