...
export class CampaignSharedSet extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v2_enums_campaign_shared_set_status_pb.CampaignSharedSetStatusEnum.CampaignSharedSetStatusMap[keyof google_ads_googleads_v2_enums_campaign_shared_set_status_pb.CampaignSharedSetStatusEnum.CampaignSharedSetStatusMap];
  setStatus(value: google_ads_googleads_v2_enums_campaign_shared_set_status_pb.CampaignSharedSetStatusEnum.CampaignSharedSetStatusMap[keyof google_ads_googleads_v2_enums_campaign_shared_set_status_pb.CampaignSharedSetStatusEnum.CampaignSharedSetStatusMap]): void;
...
export namespace CampaignSharedSet {
  export type AsObject = {
    ...
    status: google_ads_googleads_v2_enums_campaign_shared_set_status_pb.CampaignSharedSetStatusEnum.CampaignSharedSetStatusMap[keyof google_ads_googleads_v2_enums_campaign_shared_set_status_pb.CampaignSharedSetStatusEnum.CampaignSharedSetStatusMap],
  }
}
