...
export class MediaFile extends jspb.Message {
  ...
  getType(): google_ads_googleads_v2_enums_media_type_pb.MediaTypeEnum.MediaTypeMap[keyof google_ads_googleads_v2_enums_media_type_pb.MediaTypeEnum.MediaTypeMap];
  setType(value: google_ads_googleads_v2_enums_media_type_pb.MediaTypeEnum.MediaTypeMap[keyof google_ads_googleads_v2_enums_media_type_pb.MediaTypeEnum.MediaTypeMap]): void;
...
export namespace MediaFile {
  export type AsObject = {
    ...
    type: google_ads_googleads_v2_enums_media_type_pb.MediaTypeEnum.MediaTypeMap[keyof google_ads_googleads_v2_enums_media_type_pb.MediaTypeEnum.MediaTypeMap],
