...
export class ConversionAdjustment extends jspb.Message {
  ...
  getAdjustmentType(): google_ads_googleads_v2_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap[keyof google_ads_googleads_v2_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap];
  setAdjustmentType(value: google_ads_googleads_v2_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap[keyof google_ads_googleads_v2_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap]): void;
...
export namespace ConversionAdjustment {
  export type AsObject = {
    ...
    adjustmentType: google_ads_googleads_v2_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap[keyof google_ads_googleads_v2_enums_conversion_adjustment_type_pb.ConversionAdjustmentTypeEnum.ConversionAdjustmentTypeMap],
