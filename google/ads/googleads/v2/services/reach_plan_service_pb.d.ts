...
export class PlannableTargeting extends jspb.Message {
  ...
  getAgeRangesList(): Array<google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap]>;
  setAgeRangesList(value: Array<google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap]>): void;
  addAgeRanges(value: google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap], index?: number): google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap];
...
export namespace PlannableTargeting {
  export type AsObject = {
    ageRangesList: Array<google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap]>,
...
export class Preferences extends jspb.Message {
  ...
  getAdLength(): google_ads_googleads_v2_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap[keyof google_ads_googleads_v2_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap];
  setAdLength(value: google_ads_googleads_v2_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap[keyof google_ads_googleads_v2_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap]): void;
...
export namespace Preferences {
  export type AsObject = {
    ...
    adLength: google_ads_googleads_v2_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap[keyof google_ads_googleads_v2_enums_reach_plan_ad_length_pb.ReachPlanAdLengthEnum.ReachPlanAdLengthMap],
...
export class Targeting extends jspb.Message {
  ...
  getAgeRange(): google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap];
  setAgeRange(value: google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap]): void;
...
export namespace Targeting {
  export type AsObject = {
    plannableLocationId?: google_protobuf_wrappers_pb.StringValue.AsObject,
    ageRange: google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap[keyof google_ads_googleads_v2_enums_reach_plan_age_range_pb.ReachPlanAgeRangeEnum.ReachPlanAgeRangeMap],
    gendersList: Array<google_ads_googleads_v2_common_criteria_pb.GenderInfo.AsObject>,
    devicesList: Array<google_ads_googleads_v2_common_criteria_pb.DeviceInfo.AsObject>,
  }
}
