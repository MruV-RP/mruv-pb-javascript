...
export class ListInvoicesRequest extends jspb.Message {
  ...
  getIssueMonth(): google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap[keyof google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap];
  setIssueMonth(value: google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap[keyof google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap]): void;
...
export namespace ListInvoicesRequest {
  export type AsObject = {
    ...
    billingSetup: string,
    issueYear: string,
    issueMonth: google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap[keyof google_ads_googleads_v2_enums_month_of_year_pb.MonthOfYearEnum.MonthOfYearMap],
  }
}
