...
export class CreateCustomerClientRequest extends jspb.Message {
  ...
  getAccessRole(): google_ads_googleads_v2_enums_access_role_pb.AccessRoleEnum.AccessRoleMap[keyof google_ads_googleads_v2_enums_access_role_pb.AccessRoleEnum.AccessRoleMap];
  setAccessRole(value: google_ads_googleads_v2_enums_access_role_pb.AccessRoleEnum.AccessRoleMap[keyof google_ads_googleads_v2_enums_access_role_pb.AccessRoleEnum.AccessRoleMap]): void;
...
export namespace CreateCustomerClientRequest {
  export type AsObject = {
    ...
    accessRole: google_ads_googleads_v2_enums_access_role_pb.AccessRoleEnum.AccessRoleMap[keyof google_ads_googleads_v2_enums_access_role_pb.AccessRoleEnum.AccessRoleMap],
  }
}
