...
export class GenerateKeywordIdeasRequest extends jspb.Message {
  ...
  getKeywordPlanNetwork(): google_ads_googleads_v2_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap[keyof google_ads_googleads_v2_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap];
  setKeywordPlanNetwork(value: google_ads_googleads_v2_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap[keyof google_ads_googleads_v2_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap]): void;
...
export namespace GenerateKeywordIdeasRequest {
  export type AsObject = {
    ...
    keywordPlanNetwork: google_ads_googleads_v2_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap[keyof google_ads_googleads_v2_enums_keyword_plan_network_pb.KeywordPlanNetworkEnum.KeywordPlanNetworkMap],
