...
export class MutateJob extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_mutate_job_status_pb.MutateJobStatusEnum.MutateJobStatusMap[keyof google_ads_googleads_v1_enums_mutate_job_status_pb.MutateJobStatusEnum.MutateJobStatusMap];
  setStatus(value: google_ads_googleads_v1_enums_mutate_job_status_pb.MutateJobStatusEnum.MutateJobStatusMap[keyof google_ads_googleads_v1_enums_mutate_job_status_pb.MutateJobStatusEnum.MutateJobStatusMap]): void;
...
export namespace MutateJob {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_mutate_job_status_pb.MutateJobStatusEnum.MutateJobStatusMap[keyof google_ads_googleads_v1_enums_mutate_job_status_pb.MutateJobStatusEnum.MutateJobStatusMap],
