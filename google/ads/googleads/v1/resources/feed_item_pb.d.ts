...
export class FeedItem extends jspb.Message {
  ...
  getGeoTargetingRestriction(): google_ads_googleads_v1_enums_geo_targeting_restriction_pb.GeoTargetingRestrictionEnum.GeoTargetingRestrictionMap[keyof google_ads_googleads_v1_enums_geo_targeting_restriction_pb.GeoTargetingRestrictionEnum.GeoTargetingRestrictionMap];
  setGeoTargetingRestriction(value: google_ads_googleads_v1_enums_geo_targeting_restriction_pb.GeoTargetingRestrictionEnum.GeoTargetingRestrictionMap[keyof google_ads_googleads_v1_enums_geo_targeting_restriction_pb.GeoTargetingRestrictionEnum.GeoTargetingRestrictionMap]): void;
  ...
  getStatus(): google_ads_googleads_v1_enums_feed_item_status_pb.FeedItemStatusEnum.FeedItemStatusMap[keyof google_ads_googleads_v1_enums_feed_item_status_pb.FeedItemStatusEnum.FeedItemStatusMap];
  setStatus(value: google_ads_googleads_v1_enums_feed_item_status_pb.FeedItemStatusEnum.FeedItemStatusMap[keyof google_ads_googleads_v1_enums_feed_item_status_pb.FeedItemStatusEnum.FeedItemStatusMap]): void;
...
export namespace FeedItem {
  export type AsObject = {
    ...
    geoTargetingRestriction: google_ads_googleads_v1_enums_geo_targeting_restriction_pb.GeoTargetingRestrictionEnum.GeoTargetingRestrictionMap[keyof google_ads_googleads_v1_enums_geo_targeting_restriction_pb.GeoTargetingRestrictionEnum.GeoTargetingRestrictionMap],
    urlCustomParametersList: Array<google_ads_googleads_v1_common_custom_parameter_pb.CustomParameter.AsObject>,
    status: google_ads_googleads_v1_enums_feed_item_status_pb.FeedItemStatusEnum.FeedItemStatusMap[keyof google_ads_googleads_v1_enums_feed_item_status_pb.FeedItemStatusEnum.FeedItemStatusMap],
...
export class FeedItemPlaceholderPolicyInfo extends jspb.Message {
  ...
  getReviewStatus(): google_ads_googleads_v1_enums_policy_review_status_pb.PolicyReviewStatusEnum.PolicyReviewStatusMap[keyof google_ads_googleads_v1_enums_policy_review_status_pb.PolicyReviewStatusEnum.PolicyReviewStatusMap];
  setReviewStatus(value: google_ads_googleads_v1_enums_policy_review_status_pb.PolicyReviewStatusEnum.PolicyReviewStatusMap[keyof google_ads_googleads_v1_enums_policy_review_status_pb.PolicyReviewStatusEnum.PolicyReviewStatusMap]): void;

  getApprovalStatus(): google_ads_googleads_v1_enums_policy_approval_status_pb.PolicyApprovalStatusEnum.PolicyApprovalStatusMap[keyof google_ads_googleads_v1_enums_policy_approval_status_pb.PolicyApprovalStatusEnum.PolicyApprovalStatusMap];
  setApprovalStatus(value: google_ads_googleads_v1_enums_policy_approval_status_pb.PolicyApprovalStatusEnum.PolicyApprovalStatusMap[keyof google_ads_googleads_v1_enums_policy_approval_status_pb.PolicyApprovalStatusEnum.PolicyApprovalStatusMap]): void;
  ...
  getValidationStatus(): google_ads_googleads_v1_enums_feed_item_validation_status_pb.FeedItemValidationStatusEnum.FeedItemValidationStatusMap[keyof google_ads_googleads_v1_enums_feed_item_validation_status_pb.FeedItemValidationStatusEnum.FeedItemValidationStatusMap];
  setValidationStatus(value: google_ads_googleads_v1_enums_feed_item_validation_status_pb.FeedItemValidationStatusEnum.FeedItemValidationStatusMap[keyof google_ads_googleads_v1_enums_feed_item_validation_status_pb.FeedItemValidationStatusEnum.FeedItemValidationStatusMap]): void;
  ...
  getQualityApprovalStatus(): google_ads_googleads_v1_enums_feed_item_quality_approval_status_pb.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatusMap[keyof google_ads_googleads_v1_enums_feed_item_quality_approval_status_pb.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatusMap];
  setQualityApprovalStatus(value: google_ads_googleads_v1_enums_feed_item_quality_approval_status_pb.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatusMap[keyof google_ads_googleads_v1_enums_feed_item_quality_approval_status_pb.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatusMap]): void;

  clearQualityDisapprovalReasonsList(): void;
  getQualityDisapprovalReasonsList(): Array<google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReasonMap[keyof google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReasonMap]>;
  setQualityDisapprovalReasonsList(value: Array<google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReasonMap[keyof google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReasonMap]>): void;
  addQualityDisapprovalReasons(value: google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReasonMap[keyof google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReasonMap], index?: number): google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReasonMap[keyof google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReasonMap];
...
export namespace FeedItemPlaceholderPolicyInfo {
  export type AsObject = {
    ...
    reviewStatus: google_ads_googleads_v1_enums_policy_review_status_pb.PolicyReviewStatusEnum.PolicyReviewStatusMap[keyof google_ads_googleads_v1_enums_policy_review_status_pb.PolicyReviewStatusEnum.PolicyReviewStatusMap],
    approvalStatus: google_ads_googleads_v1_enums_policy_approval_status_pb.PolicyApprovalStatusEnum.PolicyApprovalStatusMap[keyof google_ads_googleads_v1_enums_policy_approval_status_pb.PolicyApprovalStatusEnum.PolicyApprovalStatusMap],
    policyTopicEntriesList: Array<google_ads_googleads_v1_common_policy_pb.PolicyTopicEntry.AsObject>,
    validationStatus: google_ads_googleads_v1_enums_feed_item_validation_status_pb.FeedItemValidationStatusEnum.FeedItemValidationStatusMap[keyof google_ads_googleads_v1_enums_feed_item_validation_status_pb.FeedItemValidationStatusEnum.FeedItemValidationStatusMap],
    validationErrorsList: Array<FeedItemValidationError.AsObject>,
    qualityApprovalStatus: google_ads_googleads_v1_enums_feed_item_quality_approval_status_pb.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatusMap[keyof google_ads_googleads_v1_enums_feed_item_quality_approval_status_pb.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatusMap],
    qualityDisapprovalReasonsList: Array<google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReasonMap[keyof google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_pb.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReasonMap]>,
  }
}

export class FeedItemValidationError extends jspb.Message {
  getValidationError(): google_ads_googleads_v1_errors_feed_item_validation_error_pb.FeedItemValidationErrorEnum.FeedItemValidationErrorMap[keyof google_ads_googleads_v1_errors_feed_item_validation_error_pb.FeedItemValidationErrorEnum.FeedItemValidationErrorMap];
  setValidationError(value: google_ads_googleads_v1_errors_feed_item_validation_error_pb.FeedItemValidationErrorEnum.FeedItemValidationErrorMap[keyof google_ads_googleads_v1_errors_feed_item_validation_error_pb.FeedItemValidationErrorEnum.FeedItemValidationErrorMap]): void;
...
export namespace FeedItemValidationError {
  export type AsObject = {
    validationError: google_ads_googleads_v1_errors_feed_item_validation_error_pb.FeedItemValidationErrorEnum.FeedItemValidationErrorMap[keyof google_ads_googleads_v1_errors_feed_item_validation_error_pb.FeedItemValidationErrorEnum.FeedItemValidationErrorMap],
