...
export class GeoTargetConstant extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_geo_target_constant_status_pb.GeoTargetConstantStatusEnum.GeoTargetConstantStatusMap[keyof google_ads_googleads_v1_enums_geo_target_constant_status_pb.GeoTargetConstantStatusEnum.GeoTargetConstantStatusMap];
  setStatus(value: google_ads_googleads_v1_enums_geo_target_constant_status_pb.GeoTargetConstantStatusEnum.GeoTargetConstantStatusMap[keyof google_ads_googleads_v1_enums_geo_target_constant_status_pb.GeoTargetConstantStatusEnum.GeoTargetConstantStatusMap]): void;
...
export namespace GeoTargetConstant {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_geo_target_constant_status_pb.GeoTargetConstantStatusEnum.GeoTargetConstantStatusMap[keyof google_ads_googleads_v1_enums_geo_target_constant_status_pb.GeoTargetConstantStatusEnum.GeoTargetConstantStatusMap],
