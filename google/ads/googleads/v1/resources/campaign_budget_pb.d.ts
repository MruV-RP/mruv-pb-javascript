...
export class CampaignBudget extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap[keyof google_ads_googleads_v1_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap];
  setStatus(value: google_ads_googleads_v1_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap[keyof google_ads_googleads_v1_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap]): void;

  getDeliveryMethod(): google_ads_googleads_v1_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap[keyof google_ads_googleads_v1_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap];
  setDeliveryMethod(value: google_ads_googleads_v1_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap[keyof google_ads_googleads_v1_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap]): void;
  ...
  getPeriod(): google_ads_googleads_v1_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap[keyof google_ads_googleads_v1_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap];
  setPeriod(value: google_ads_googleads_v1_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap[keyof google_ads_googleads_v1_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap]): void;
  ...
  getType(): google_ads_googleads_v1_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap[keyof google_ads_googleads_v1_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap];
  setType(value: google_ads_googleads_v1_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap[keyof google_ads_googleads_v1_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap]): void;
...
export namespace CampaignBudget {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap[keyof google_ads_googleads_v1_enums_budget_status_pb.BudgetStatusEnum.BudgetStatusMap],
    deliveryMethod: google_ads_googleads_v1_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap[keyof google_ads_googleads_v1_enums_budget_delivery_method_pb.BudgetDeliveryMethodEnum.BudgetDeliveryMethodMap],
    ...
    period: google_ads_googleads_v1_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap[keyof google_ads_googleads_v1_enums_budget_period_pb.BudgetPeriodEnum.BudgetPeriodMap],
    ...
    type: google_ads_googleads_v1_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap[keyof google_ads_googleads_v1_enums_budget_type_pb.BudgetTypeEnum.BudgetTypeMap],
  }
}
