...
export class Campaign extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_campaign_status_pb.CampaignStatusEnum.CampaignStatusMap[keyof google_ads_googleads_v1_enums_campaign_status_pb.CampaignStatusEnum.CampaignStatusMap];
  setStatus(value: google_ads_googleads_v1_enums_campaign_status_pb.CampaignStatusEnum.CampaignStatusMap[keyof google_ads_googleads_v1_enums_campaign_status_pb.CampaignStatusEnum.CampaignStatusMap]): void;

  getServingStatus(): google_ads_googleads_v1_enums_campaign_serving_status_pb.CampaignServingStatusEnum.CampaignServingStatusMap[keyof google_ads_googleads_v1_enums_campaign_serving_status_pb.CampaignServingStatusEnum.CampaignServingStatusMap];
  setServingStatus(value: google_ads_googleads_v1_enums_campaign_serving_status_pb.CampaignServingStatusEnum.CampaignServingStatusMap[keyof google_ads_googleads_v1_enums_campaign_serving_status_pb.CampaignServingStatusEnum.CampaignServingStatusMap]): void;

  getAdServingOptimizationStatus(): google_ads_googleads_v1_enums_ad_serving_optimization_status_pb.AdServingOptimizationStatusEnum.AdServingOptimizationStatusMap[keyof google_ads_googleads_v1_enums_ad_serving_optimization_status_pb.AdServingOptimizationStatusEnum.AdServingOptimizationStatusMap];
  setAdServingOptimizationStatus(value: google_ads_googleads_v1_enums_ad_serving_optimization_status_pb.AdServingOptimizationStatusEnum.AdServingOptimizationStatusMap[keyof google_ads_googleads_v1_enums_ad_serving_optimization_status_pb.AdServingOptimizationStatusEnum.AdServingOptimizationStatusMap]): void;

  getAdvertisingChannelType(): google_ads_googleads_v1_enums_advertising_channel_type_pb.AdvertisingChannelTypeEnum.AdvertisingChannelTypeMap[keyof google_ads_googleads_v1_enums_advertising_channel_type_pb.AdvertisingChannelTypeEnum.AdvertisingChannelTypeMap];
  setAdvertisingChannelType(value: google_ads_googleads_v1_enums_advertising_channel_type_pb.AdvertisingChannelTypeEnum.AdvertisingChannelTypeMap[keyof google_ads_googleads_v1_enums_advertising_channel_type_pb.AdvertisingChannelTypeEnum.AdvertisingChannelTypeMap]): void;

  getAdvertisingChannelSubType(): google_ads_googleads_v1_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubTypeMap[keyof google_ads_googleads_v1_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubTypeMap];
  setAdvertisingChannelSubType(value: google_ads_googleads_v1_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubTypeMap[keyof google_ads_googleads_v1_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubTypeMap]): void;
  ...
  getExperimentType(): google_ads_googleads_v1_enums_campaign_experiment_type_pb.CampaignExperimentTypeEnum.CampaignExperimentTypeMap[keyof google_ads_googleads_v1_enums_campaign_experiment_type_pb.CampaignExperimentTypeEnum.CampaignExperimentTypeMap];
  setExperimentType(value: google_ads_googleads_v1_enums_campaign_experiment_type_pb.CampaignExperimentTypeEnum.CampaignExperimentTypeMap[keyof google_ads_googleads_v1_enums_campaign_experiment_type_pb.CampaignExperimentTypeEnum.CampaignExperimentTypeMap]): void;
  ...
  getBiddingStrategyType(): google_ads_googleads_v1_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap[keyof google_ads_googleads_v1_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap];
  setBiddingStrategyType(value: google_ads_googleads_v1_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap[keyof google_ads_googleads_v1_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap]): void;
  ...
  getVideoBrandSafetySuitability(): google_ads_googleads_v1_enums_brand_safety_suitability_pb.BrandSafetySuitabilityEnum.BrandSafetySuitabilityMap[keyof google_ads_googleads_v1_enums_brand_safety_suitability_pb.BrandSafetySuitabilityEnum.BrandSafetySuitabilityMap];
  setVideoBrandSafetySuitability(value: google_ads_googleads_v1_enums_brand_safety_suitability_pb.BrandSafetySuitabilityEnum.BrandSafetySuitabilityMap[keyof google_ads_googleads_v1_enums_brand_safety_suitability_pb.BrandSafetySuitabilityEnum.BrandSafetySuitabilityMap]): void;
  ...
  getPaymentMode(): google_ads_googleads_v1_enums_payment_mode_pb.PaymentModeEnum.PaymentModeMap[keyof google_ads_googleads_v1_enums_payment_mode_pb.PaymentModeEnum.PaymentModeMap];
  setPaymentMode(value: google_ads_googleads_v1_enums_payment_mode_pb.PaymentModeEnum.PaymentModeMap[keyof google_ads_googleads_v1_enums_payment_mode_pb.PaymentModeEnum.PaymentModeMap]): void;
...
export namespace Campaign {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_campaign_status_pb.CampaignStatusEnum.CampaignStatusMap[keyof google_ads_googleads_v1_enums_campaign_status_pb.CampaignStatusEnum.CampaignStatusMap],
    servingStatus: google_ads_googleads_v1_enums_campaign_serving_status_pb.CampaignServingStatusEnum.CampaignServingStatusMap[keyof google_ads_googleads_v1_enums_campaign_serving_status_pb.CampaignServingStatusEnum.CampaignServingStatusMap],
    adServingOptimizationStatus: google_ads_googleads_v1_enums_ad_serving_optimization_status_pb.AdServingOptimizationStatusEnum.AdServingOptimizationStatusMap[keyof google_ads_googleads_v1_enums_ad_serving_optimization_status_pb.AdServingOptimizationStatusEnum.AdServingOptimizationStatusMap],
    advertisingChannelType: google_ads_googleads_v1_enums_advertising_channel_type_pb.AdvertisingChannelTypeEnum.AdvertisingChannelTypeMap[keyof google_ads_googleads_v1_enums_advertising_channel_type_pb.AdvertisingChannelTypeEnum.AdvertisingChannelTypeMap],
    advertisingChannelSubType: google_ads_googleads_v1_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubTypeMap[keyof google_ads_googleads_v1_enums_advertising_channel_sub_type_pb.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubTypeMap],
    ...
    experimentType: google_ads_googleads_v1_enums_campaign_experiment_type_pb.CampaignExperimentTypeEnum.CampaignExperimentTypeMap[keyof google_ads_googleads_v1_enums_campaign_experiment_type_pb.CampaignExperimentTypeEnum.CampaignExperimentTypeMap],
    ...
    biddingStrategyType: google_ads_googleads_v1_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap[keyof google_ads_googleads_v1_enums_bidding_strategy_type_pb.BiddingStrategyTypeEnum.BiddingStrategyTypeMap],
    ...
    videoBrandSafetySuitability: google_ads_googleads_v1_enums_brand_safety_suitability_pb.BrandSafetySuitabilityEnum.BrandSafetySuitabilityMap[keyof google_ads_googleads_v1_enums_brand_safety_suitability_pb.BrandSafetySuitabilityEnum.BrandSafetySuitabilityMap],
    ...
    paymentMode: google_ads_googleads_v1_enums_payment_mode_pb.PaymentModeEnum.PaymentModeMap[keyof google_ads_googleads_v1_enums_payment_mode_pb.PaymentModeEnum.PaymentModeMap],
  ...
  export class VanityPharma extends jspb.Message {
    getVanityPharmaDisplayUrlMode(): google_ads_googleads_v1_enums_vanity_pharma_display_url_mode_pb.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlModeMap[keyof google_ads_googleads_v1_enums_vanity_pharma_display_url_mode_pb.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlModeMap];
    setVanityPharmaDisplayUrlMode(value: google_ads_googleads_v1_enums_vanity_pharma_display_url_mode_pb.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlModeMap[keyof google_ads_googleads_v1_enums_vanity_pharma_display_url_mode_pb.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlModeMap]): void;

    getVanityPharmaText(): google_ads_googleads_v1_enums_vanity_pharma_text_pb.VanityPharmaTextEnum.VanityPharmaTextMap[keyof google_ads_googleads_v1_enums_vanity_pharma_text_pb.VanityPharmaTextEnum.VanityPharmaTextMap];
    setVanityPharmaText(value: google_ads_googleads_v1_enums_vanity_pharma_text_pb.VanityPharmaTextEnum.VanityPharmaTextMap[keyof google_ads_googleads_v1_enums_vanity_pharma_text_pb.VanityPharmaTextEnum.VanityPharmaTextMap]): void;
  ...
  export namespace VanityPharma {
    export type AsObject = {
      vanityPharmaDisplayUrlMode: google_ads_googleads_v1_enums_vanity_pharma_display_url_mode_pb.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlModeMap[keyof google_ads_googleads_v1_enums_vanity_pharma_display_url_mode_pb.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlModeMap],
      vanityPharmaText: google_ads_googleads_v1_enums_vanity_pharma_text_pb.VanityPharmaTextEnum.VanityPharmaTextMap[keyof google_ads_googleads_v1_enums_vanity_pharma_text_pb.VanityPharmaTextEnum.VanityPharmaTextMap],
    }
  }
  ...
  export class AppCampaignSetting extends jspb.Message {
    getBiddingStrategyGoalType(): google_ads_googleads_v1_enums_app_campaign_bidding_strategy_goal_type_pb.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalTypeMap[keyof google_ads_googleads_v1_enums_app_campaign_bidding_strategy_goal_type_pb.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalTypeMap];
    setBiddingStrategyGoalType(value: google_ads_googleads_v1_enums_app_campaign_bidding_strategy_goal_type_pb.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalTypeMap[keyof google_ads_googleads_v1_enums_app_campaign_bidding_strategy_goal_type_pb.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalTypeMap]): void;
    ...
    getAppStore(): google_ads_googleads_v1_enums_app_campaign_app_store_pb.AppCampaignAppStoreEnum.AppCampaignAppStoreMap[keyof google_ads_googleads_v1_enums_app_campaign_app_store_pb.AppCampaignAppStoreEnum.AppCampaignAppStoreMap];
    setAppStore(value: google_ads_googleads_v1_enums_app_campaign_app_store_pb.AppCampaignAppStoreEnum.AppCampaignAppStoreMap[keyof google_ads_googleads_v1_enums_app_campaign_app_store_pb.AppCampaignAppStoreEnum.AppCampaignAppStoreMap]): void;
  ...
  export namespace AppCampaignSetting {
    export type AsObject = {
      biddingStrategyGoalType: google_ads_googleads_v1_enums_app_campaign_bidding_strategy_goal_type_pb.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalTypeMap[keyof google_ads_googleads_v1_enums_app_campaign_bidding_strategy_goal_type_pb.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalTypeMap],
      appId?: google_protobuf_wrappers_pb.StringValue.AsObject,
      appStore: google_ads_googleads_v1_enums_app_campaign_app_store_pb.AppCampaignAppStoreEnum.AppCampaignAppStoreMap[keyof google_ads_googleads_v1_enums_app_campaign_app_store_pb.AppCampaignAppStoreEnum.AppCampaignAppStoreMap],
    }
  }

  export class GeoTargetTypeSetting extends jspb.Message {
    getPositiveGeoTargetType(): google_ads_googleads_v1_enums_positive_geo_target_type_pb.PositiveGeoTargetTypeEnum.PositiveGeoTargetTypeMap[keyof google_ads_googleads_v1_enums_positive_geo_target_type_pb.PositiveGeoTargetTypeEnum.PositiveGeoTargetTypeMap];
    setPositiveGeoTargetType(value: google_ads_googleads_v1_enums_positive_geo_target_type_pb.PositiveGeoTargetTypeEnum.PositiveGeoTargetTypeMap[keyof google_ads_googleads_v1_enums_positive_geo_target_type_pb.PositiveGeoTargetTypeEnum.PositiveGeoTargetTypeMap]): void;

    getNegativeGeoTargetType(): google_ads_googleads_v1_enums_negative_geo_target_type_pb.NegativeGeoTargetTypeEnum.NegativeGeoTargetTypeMap[keyof google_ads_googleads_v1_enums_negative_geo_target_type_pb.NegativeGeoTargetTypeEnum.NegativeGeoTargetTypeMap];
    setNegativeGeoTargetType(value: google_ads_googleads_v1_enums_negative_geo_target_type_pb.NegativeGeoTargetTypeEnum.NegativeGeoTargetTypeMap[keyof google_ads_googleads_v1_enums_negative_geo_target_type_pb.NegativeGeoTargetTypeEnum.NegativeGeoTargetTypeMap]): void;
  ...
  export namespace GeoTargetTypeSetting {
    export type AsObject = {
      positiveGeoTargetType: google_ads_googleads_v1_enums_positive_geo_target_type_pb.PositiveGeoTargetTypeEnum.PositiveGeoTargetTypeMap[keyof google_ads_googleads_v1_enums_positive_geo_target_type_pb.PositiveGeoTargetTypeEnum.PositiveGeoTargetTypeMap],
      negativeGeoTargetType: google_ads_googleads_v1_enums_negative_geo_target_type_pb.NegativeGeoTargetTypeEnum.NegativeGeoTargetTypeMap[keyof google_ads_googleads_v1_enums_negative_geo_target_type_pb.NegativeGeoTargetTypeEnum.NegativeGeoTargetTypeMap],
    }
  }
