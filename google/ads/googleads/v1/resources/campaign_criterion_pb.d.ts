...
export class CampaignCriterion extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_campaign_criterion_status_pb.CampaignCriterionStatusEnum.CampaignCriterionStatusMap[keyof google_ads_googleads_v1_enums_campaign_criterion_status_pb.CampaignCriterionStatusEnum.CampaignCriterionStatusMap];
  setStatus(value: google_ads_googleads_v1_enums_campaign_criterion_status_pb.CampaignCriterionStatusEnum.CampaignCriterionStatusMap[keyof google_ads_googleads_v1_enums_campaign_criterion_status_pb.CampaignCriterionStatusEnum.CampaignCriterionStatusMap]): void;
...
export namespace CampaignCriterion {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_campaign_criterion_status_pb.CampaignCriterionStatusEnum.CampaignCriterionStatusMap[keyof google_ads_googleads_v1_enums_campaign_criterion_status_pb.CampaignCriterionStatusEnum.CampaignCriterionStatusMap],
