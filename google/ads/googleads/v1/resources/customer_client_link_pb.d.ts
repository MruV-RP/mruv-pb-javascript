...
export class CustomerClientLink extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_manager_link_status_pb.ManagerLinkStatusEnum.ManagerLinkStatusMap[keyof google_ads_googleads_v1_enums_manager_link_status_pb.ManagerLinkStatusEnum.ManagerLinkStatusMap];
  setStatus(value: google_ads_googleads_v1_enums_manager_link_status_pb.ManagerLinkStatusEnum.ManagerLinkStatusMap[keyof google_ads_googleads_v1_enums_manager_link_status_pb.ManagerLinkStatusEnum.ManagerLinkStatusMap]): void;
...
export namespace CustomerClientLink {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_manager_link_status_pb.ManagerLinkStatusEnum.ManagerLinkStatusMap[keyof google_ads_googleads_v1_enums_manager_link_status_pb.ManagerLinkStatusEnum.ManagerLinkStatusMap],
