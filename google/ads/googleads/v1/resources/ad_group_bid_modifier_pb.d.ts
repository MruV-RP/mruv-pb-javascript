...
export class AdGroupBidModifier extends jspb.Message {
  ...
  getBidModifierSource(): google_ads_googleads_v1_enums_bid_modifier_source_pb.BidModifierSourceEnum.BidModifierSourceMap[keyof google_ads_googleads_v1_enums_bid_modifier_source_pb.BidModifierSourceEnum.BidModifierSourceMap];
  setBidModifierSource(value: google_ads_googleads_v1_enums_bid_modifier_source_pb.BidModifierSourceEnum.BidModifierSourceMap[keyof google_ads_googleads_v1_enums_bid_modifier_source_pb.BidModifierSourceEnum.BidModifierSourceMap]): void;
...
export namespace AdGroupBidModifier {
  export type AsObject = {
    ...
    bidModifierSource: google_ads_googleads_v1_enums_bid_modifier_source_pb.BidModifierSourceEnum.BidModifierSourceMap[keyof google_ads_googleads_v1_enums_bid_modifier_source_pb.BidModifierSourceEnum.BidModifierSourceMap],
