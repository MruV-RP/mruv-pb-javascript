...
export class FeedItemTarget extends jspb.Message {
  ...
  getFeedItemTargetType(): google_ads_googleads_v1_enums_feed_item_target_type_pb.FeedItemTargetTypeEnum.FeedItemTargetTypeMap[keyof google_ads_googleads_v1_enums_feed_item_target_type_pb.FeedItemTargetTypeEnum.FeedItemTargetTypeMap];
  setFeedItemTargetType(value: google_ads_googleads_v1_enums_feed_item_target_type_pb.FeedItemTargetTypeEnum.FeedItemTargetTypeMap[keyof google_ads_googleads_v1_enums_feed_item_target_type_pb.FeedItemTargetTypeEnum.FeedItemTargetTypeMap]): void;
...
export namespace FeedItemTarget {
  export type AsObject = {
    ...
    feedItemTargetType: google_ads_googleads_v1_enums_feed_item_target_type_pb.FeedItemTargetTypeEnum.FeedItemTargetTypeMap[keyof google_ads_googleads_v1_enums_feed_item_target_type_pb.FeedItemTargetTypeEnum.FeedItemTargetTypeMap],
