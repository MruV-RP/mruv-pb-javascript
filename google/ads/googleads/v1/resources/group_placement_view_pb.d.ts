...
export class GroupPlacementView extends jspb.Message {
  ...
  getPlacementType(): google_ads_googleads_v1_enums_placement_type_pb.PlacementTypeEnum.PlacementTypeMap[keyof google_ads_googleads_v1_enums_placement_type_pb.PlacementTypeEnum.PlacementTypeMap];
  setPlacementType(value: google_ads_googleads_v1_enums_placement_type_pb.PlacementTypeEnum.PlacementTypeMap[keyof google_ads_googleads_v1_enums_placement_type_pb.PlacementTypeEnum.PlacementTypeMap]): void;
...
export namespace GroupPlacementView {
  export type AsObject = {
    ...
    placementType: google_ads_googleads_v1_enums_placement_type_pb.PlacementTypeEnum.PlacementTypeMap[keyof google_ads_googleads_v1_enums_placement_type_pb.PlacementTypeEnum.PlacementTypeMap],
  }
}
