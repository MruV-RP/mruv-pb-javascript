...
export class MerchantCenterLink extends jspb.Message {
  ...
  getStatus(): google_ads_googleads_v1_enums_merchant_center_link_status_pb.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatusMap[keyof google_ads_googleads_v1_enums_merchant_center_link_status_pb.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatusMap];
  setStatus(value: google_ads_googleads_v1_enums_merchant_center_link_status_pb.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatusMap[keyof google_ads_googleads_v1_enums_merchant_center_link_status_pb.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatusMap]): void;
...
export namespace MerchantCenterLink {
  export type AsObject = {
    ...
    status: google_ads_googleads_v1_enums_merchant_center_link_status_pb.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatusMap[keyof google_ads_googleads_v1_enums_merchant_center_link_status_pb.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatusMap],
  }
}
