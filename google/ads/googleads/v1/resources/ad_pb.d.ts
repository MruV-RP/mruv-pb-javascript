...
export class Ad extends jspb.Message {
  ...
  getType(): google_ads_googleads_v1_enums_ad_type_pb.AdTypeEnum.AdTypeMap[keyof google_ads_googleads_v1_enums_ad_type_pb.AdTypeEnum.AdTypeMap];
  setType(value: google_ads_googleads_v1_enums_ad_type_pb.AdTypeEnum.AdTypeMap[keyof google_ads_googleads_v1_enums_ad_type_pb.AdTypeEnum.AdTypeMap]): void;
  ...
  getDevicePreference(): google_ads_googleads_v1_enums_device_pb.DeviceEnum.DeviceMap[keyof google_ads_googleads_v1_enums_device_pb.DeviceEnum.DeviceMap];
  setDevicePreference(value: google_ads_googleads_v1_enums_device_pb.DeviceEnum.DeviceMap[keyof google_ads_googleads_v1_enums_device_pb.DeviceEnum.DeviceMap]): void;
  ...
  getSystemManagedResourceSource(): google_ads_googleads_v1_enums_system_managed_entity_source_pb.SystemManagedResourceSourceEnum.SystemManagedResourceSourceMap[keyof google_ads_googleads_v1_enums_system_managed_entity_source_pb.SystemManagedResourceSourceEnum.SystemManagedResourceSourceMap];
  setSystemManagedResourceSource(value: google_ads_googleads_v1_enums_system_managed_entity_source_pb.SystemManagedResourceSourceEnum.SystemManagedResourceSourceMap[keyof google_ads_googleads_v1_enums_system_managed_entity_source_pb.SystemManagedResourceSourceEnum.SystemManagedResourceSourceMap]): void;
...
export namespace Ad {
  export type AsObject = {
    ...
    type: google_ads_googleads_v1_enums_ad_type_pb.AdTypeEnum.AdTypeMap[keyof google_ads_googleads_v1_enums_ad_type_pb.AdTypeEnum.AdTypeMap],
    addedByGoogleAds?: google_protobuf_wrappers_pb.BoolValue.AsObject,
    devicePreference: google_ads_googleads_v1_enums_device_pb.DeviceEnum.DeviceMap[keyof google_ads_googleads_v1_enums_device_pb.DeviceEnum.DeviceMap],
    urlCollectionsList: Array<google_ads_googleads_v1_common_url_collection_pb.UrlCollection.AsObject>,
    name?: google_protobuf_wrappers_pb.StringValue.AsObject,
    systemManagedResourceSource: google_ads_googleads_v1_enums_system_managed_entity_source_pb.SystemManagedResourceSourceEnum.SystemManagedResourceSourceMap[keyof google_ads_googleads_v1_enums_system_managed_entity_source_pb.SystemManagedResourceSourceEnum.SystemManagedResourceSourceMap],
