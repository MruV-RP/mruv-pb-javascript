...
export class ChangeStatus extends jspb.Message {
  ...
  getResourceType(): google_ads_googleads_v1_enums_change_status_resource_type_pb.ChangeStatusResourceTypeEnum.ChangeStatusResourceTypeMap[keyof google_ads_googleads_v1_enums_change_status_resource_type_pb.ChangeStatusResourceTypeEnum.ChangeStatusResourceTypeMap];
  setResourceType(value: google_ads_googleads_v1_enums_change_status_resource_type_pb.ChangeStatusResourceTypeEnum.ChangeStatusResourceTypeMap[keyof google_ads_googleads_v1_enums_change_status_resource_type_pb.ChangeStatusResourceTypeEnum.ChangeStatusResourceTypeMap]): void;
  ...
  getResourceStatus(): google_ads_googleads_v1_enums_change_status_operation_pb.ChangeStatusOperationEnum.ChangeStatusOperationMap[keyof google_ads_googleads_v1_enums_change_status_operation_pb.ChangeStatusOperationEnum.ChangeStatusOperationMap];
  setResourceStatus(value: google_ads_googleads_v1_enums_change_status_operation_pb.ChangeStatusOperationEnum.ChangeStatusOperationMap[keyof google_ads_googleads_v1_enums_change_status_operation_pb.ChangeStatusOperationEnum.ChangeStatusOperationMap]): void;
...
export namespace ChangeStatus {
  export type AsObject = {
    ...
    resourceType: google_ads_googleads_v1_enums_change_status_resource_type_pb.ChangeStatusResourceTypeEnum.ChangeStatusResourceTypeMap[keyof google_ads_googleads_v1_enums_change_status_resource_type_pb.ChangeStatusResourceTypeEnum.ChangeStatusResourceTypeMap],
    campaign?: google_protobuf_wrappers_pb.StringValue.AsObject,
    adGroup?: google_protobuf_wrappers_pb.StringValue.AsObject,
    resourceStatus: google_ads_googleads_v1_enums_change_status_operation_pb.ChangeStatusOperationEnum.ChangeStatusOperationMap[keyof google_ads_googleads_v1_enums_change_status_operation_pb.ChangeStatusOperationEnum.ChangeStatusOperationMap],
