...
export class KeywordPlanHistoricalMetrics extends jspb.Message {
  ...
  getCompetition(): google_ads_googleads_v1_enums_keyword_plan_competition_level_pb.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevelMap[keyof google_ads_googleads_v1_enums_keyword_plan_competition_level_pb.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevelMap];
  setCompetition(value: google_ads_googleads_v1_enums_keyword_plan_competition_level_pb.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevelMap[keyof google_ads_googleads_v1_enums_keyword_plan_competition_level_pb.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevelMap]): void;
...
export namespace KeywordPlanHistoricalMetrics {
  export type AsObject = {
    ...
    competition: google_ads_googleads_v1_enums_keyword_plan_competition_level_pb.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevelMap[keyof google_ads_googleads_v1_enums_keyword_plan_competition_level_pb.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevelMap],
  }
}
