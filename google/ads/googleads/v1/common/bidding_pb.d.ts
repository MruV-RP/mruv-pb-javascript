...
export class PageOnePromoted extends jspb.Message {
  getStrategyGoal(): google_ads_googleads_v1_enums_page_one_promoted_strategy_goal_pb.PageOnePromotedStrategyGoalEnum.PageOnePromotedStrategyGoalMap[keyof google_ads_googleads_v1_enums_page_one_promoted_strategy_goal_pb.PageOnePromotedStrategyGoalEnum.PageOnePromotedStrategyGoalMap];
  setStrategyGoal(value: google_ads_googleads_v1_enums_page_one_promoted_strategy_goal_pb.PageOnePromotedStrategyGoalEnum.PageOnePromotedStrategyGoalMap[keyof google_ads_googleads_v1_enums_page_one_promoted_strategy_goal_pb.PageOnePromotedStrategyGoalEnum.PageOnePromotedStrategyGoalMap]): void;
...
export namespace PageOnePromoted {
  export type AsObject = {
    strategyGoal: google_ads_googleads_v1_enums_page_one_promoted_strategy_goal_pb.PageOnePromotedStrategyGoalEnum.PageOnePromotedStrategyGoalMap[keyof google_ads_googleads_v1_enums_page_one_promoted_strategy_goal_pb.PageOnePromotedStrategyGoalEnum.PageOnePromotedStrategyGoalMap],
...
export class TargetImpressionShare extends jspb.Message {
  getLocation(): google_ads_googleads_v1_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap[keyof google_ads_googleads_v1_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap];
  setLocation(value: google_ads_googleads_v1_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap[keyof google_ads_googleads_v1_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap]): void;
...
export namespace TargetImpressionShare {
  export type AsObject = {
    location: google_ads_googleads_v1_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap[keyof google_ads_googleads_v1_enums_target_impression_share_location_pb.TargetImpressionShareLocationEnum.TargetImpressionShareLocationMap],
