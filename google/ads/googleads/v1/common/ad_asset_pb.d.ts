...
export class AdTextAsset extends jspb.Message {
  ...
  getPinnedField(): google_ads_googleads_v1_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap[keyof google_ads_googleads_v1_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap];
  setPinnedField(value: google_ads_googleads_v1_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap[keyof google_ads_googleads_v1_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap]): void;
...
export namespace AdTextAsset {
  export type AsObject = {
    ...
    pinnedField: google_ads_googleads_v1_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap[keyof google_ads_googleads_v1_enums_served_asset_field_type_pb.ServedAssetFieldTypeEnum.ServedAssetFieldTypeMap],
  }
}
