...
// file: google/bigtable/v1/bigtable_data.proto
...
export class ColumnRange extends jspb.Message {
  ...
  hasStartQualifierInclusive(): boolean;
  clearStartQualifierInclusive(): void;
  ...
  hasStartQualifierExclusive(): boolean;
  clearStartQualifierExclusive(): void;
  ...
  hasEndQualifierInclusive(): boolean;
  clearEndQualifierInclusive(): void;
  ...
  hasEndQualifierExclusive(): boolean;
  clearEndQualifierExclusive(): void;
...
export class ValueRange extends jspb.Message {
  hasStartValueInclusive(): boolean;
  clearStartValueInclusive(): void;
  ...
  hasStartValueExclusive(): boolean;
  clearStartValueExclusive(): void;
  ...
  hasEndValueInclusive(): boolean;
  clearEndValueInclusive(): void;
  ...
  hasEndValueExclusive(): boolean;
  clearEndValueExclusive(): void;
