...
// file: google/bigtable/v2/data.proto
...
export class RowRange extends jspb.Message {
  hasStartKeyClosed(): boolean;
  clearStartKeyClosed(): void;
  ...
  hasStartKeyOpen(): boolean;
  clearStartKeyOpen(): void;
  ...
  hasEndKeyOpen(): boolean;
  clearEndKeyOpen(): void;
  ...
  hasEndKeyClosed(): boolean;
  clearEndKeyClosed(): void;
...
export class RowSet extends jspb.Message {
  ...
  getRowKeysList_asU8(): Array<Uint8Array>;
  getRowKeysList_asB64(): Array<string>;
  setRowKeysList(value: Array<Uint8Array | string>): void;
  addRowKeys(value: Uint8Array | string, index?: number): Uint8Array | string;
...
export class ColumnRange extends jspb.Message {
  ...
  hasStartQualifierClosed(): boolean;
  clearStartQualifierClosed(): void;
  ...
  hasStartQualifierOpen(): boolean;
  clearStartQualifierOpen(): void;
  ...
  hasEndQualifierClosed(): boolean;
  clearEndQualifierClosed(): void;
  ...
  hasEndQualifierOpen(): boolean;
  clearEndQualifierOpen(): void;
...
export class ValueRange extends jspb.Message {
  hasStartValueClosed(): boolean;
  clearStartValueClosed(): void;
  ...
  hasStartValueOpen(): boolean;
  clearStartValueOpen(): void;
  ...
  hasEndValueClosed(): boolean;
  clearEndValueClosed(): void;
  ...
  hasEndValueOpen(): boolean;
  clearEndValueOpen(): void;
...
export class RowFilter extends jspb.Message {
  ...
  hasPassAllFilter(): boolean;
  clearPassAllFilter(): void;
  getPassAllFilter(): boolean;
  setPassAllFilter(value: boolean): void;

  hasBlockAllFilter(): boolean;
  clearBlockAllFilter(): void;
  getBlockAllFilter(): boolean;
  setBlockAllFilter(value: boolean): void;

  hasRowKeyRegexFilter(): boolean;
  clearRowKeyRegexFilter(): void;
  ...
  hasRowSampleFilter(): boolean;
  clearRowSampleFilter(): void;
  getRowSampleFilter(): number;
  setRowSampleFilter(value: number): void;

  hasFamilyNameRegexFilter(): boolean;
  clearFamilyNameRegexFilter(): void;
  getFamilyNameRegexFilter(): string;
  setFamilyNameRegexFilter(value: string): void;

  hasColumnQualifierRegexFilter(): boolean;
  clearColumnQualifierRegexFilter(): void;
  ...
  hasValueRegexFilter(): boolean;
  clearValueRegexFilter(): void;
  ...
  hasCellsPerRowOffsetFilter(): boolean;
  clearCellsPerRowOffsetFilter(): void;
  getCellsPerRowOffsetFilter(): number;
  setCellsPerRowOffsetFilter(value: number): void;

  hasCellsPerRowLimitFilter(): boolean;
  clearCellsPerRowLimitFilter(): void;
  getCellsPerRowLimitFilter(): number;
  setCellsPerRowLimitFilter(value: number): void;

  hasCellsPerColumnLimitFilter(): boolean;
  clearCellsPerColumnLimitFilter(): void;
  getCellsPerColumnLimitFilter(): number;
  setCellsPerColumnLimitFilter(value: number): void;

  hasStripValueTransformer(): boolean;
  clearStripValueTransformer(): void;
  getStripValueTransformer(): boolean;
  setStripValueTransformer(value: boolean): void;

  hasApplyLabelTransformer(): boolean;
  clearApplyLabelTransformer(): void;
...
export class ReadModifyWriteRule extends jspb.Message {
  ...
  hasAppendValue(): boolean;
  clearAppendValue(): void;
  ...
  hasIncrementAmount(): boolean;
  clearIncrementAmount(): void;
