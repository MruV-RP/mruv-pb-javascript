...
export class CustomInfoType extends jspb.Message {
  ...
  getLikelihood(): LikelihoodMap[keyof LikelihoodMap];
  setLikelihood(value: LikelihoodMap[keyof LikelihoodMap]): void;
  ...
  getExclusionType(): CustomInfoType.ExclusionTypeMap[keyof CustomInfoType.ExclusionTypeMap];
  setExclusionType(value: CustomInfoType.ExclusionTypeMap[keyof CustomInfoType.ExclusionTypeMap]): void;
...
export namespace CustomInfoType {
  export type AsObject = {
    ...
    likelihood: LikelihoodMap[keyof LikelihoodMap],
    ...
    exclusionType: CustomInfoType.ExclusionTypeMap[keyof CustomInfoType.ExclusionTypeMap],
  }
  ...
  export class Regex extends jspb.Message {
    ...
    addGroupIndexes(value: number, index?: number): number;
  ...
  export namespace DetectionRule {
    ...
    export class LikelihoodAdjustment extends jspb.Message {
      ...
      getFixedLikelihood(): LikelihoodMap[keyof LikelihoodMap];
      setFixedLikelihood(value: LikelihoodMap[keyof LikelihoodMap]): void;
    ...
    export namespace LikelihoodAdjustment {
      export type AsObject = {
        fixedLikelihood: LikelihoodMap[keyof LikelihoodMap],
  ...
  export interface ExclusionTypeMap {
    EXCLUSION_TYPE_UNSPECIFIED: 0;
    EXCLUSION_TYPE_EXCLUDE: 1;
  }

  export const ExclusionType: ExclusionTypeMap;
...
export class CloudStorageOptions extends jspb.Message {
  ...
  getFileTypesList(): Array<FileTypeMap[keyof FileTypeMap]>;
  setFileTypesList(value: Array<FileTypeMap[keyof FileTypeMap]>): void;
  addFileTypes(value: FileTypeMap[keyof FileTypeMap], index?: number): FileTypeMap[keyof FileTypeMap];

  getSampleMethod(): CloudStorageOptions.SampleMethodMap[keyof CloudStorageOptions.SampleMethodMap];
  setSampleMethod(value: CloudStorageOptions.SampleMethodMap[keyof CloudStorageOptions.SampleMethodMap]): void;
...
export namespace CloudStorageOptions {
  export type AsObject = {
    ...
    fileTypesList: Array<FileTypeMap[keyof FileTypeMap]>,
    sampleMethod: CloudStorageOptions.SampleMethodMap[keyof CloudStorageOptions.SampleMethodMap],
  ...
  export interface SampleMethodMap {
    SAMPLE_METHOD_UNSPECIFIED: 0;
    TOP: 1;
    RANDOM_START: 2;
  }

  export const SampleMethod: SampleMethodMap;
}
...
export class BigQueryOptions extends jspb.Message {
  ...
  getSampleMethod(): BigQueryOptions.SampleMethodMap[keyof BigQueryOptions.SampleMethodMap];
  setSampleMethod(value: BigQueryOptions.SampleMethodMap[keyof BigQueryOptions.SampleMethodMap]): void;
...
export namespace BigQueryOptions {
  export type AsObject = {
    ...
    sampleMethod: BigQueryOptions.SampleMethodMap[keyof BigQueryOptions.SampleMethodMap],
...
export class RecordKey extends jspb.Message {
  ...
  addIdValues(value: string, index?: number): string;
