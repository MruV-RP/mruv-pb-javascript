...
var google_watcher_v1_watch_pb = require('../../../google/watcher/v1/watch_pb.js');
var google_api_annotations_pb = require('../../../google/api/annotations_pb.js');
var google_protobuf_any_pb = require('google-protobuf/google/protobuf/any_pb.js');
var google_protobuf_empty_pb = require('google-protobuf/google/protobuf/empty_pb.js');

function serialize_google_watcher_v1_ChangeBatch(arg) {
  if (!(arg instanceof google_watcher_v1_watch_pb.ChangeBatch)) {
    throw new Error('Expected argument of type google.watcher.v1.ChangeBatch');
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_google_watcher_v1_ChangeBatch(buffer_arg) {
  return google_watcher_v1_watch_pb.ChangeBatch.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_google_watcher_v1_Request(arg) {
  if (!(arg instanceof google_watcher_v1_watch_pb.Request)) {
    throw new Error('Expected argument of type google.watcher.v1.Request');
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_google_watcher_v1_Request(buffer_arg) {
  return google_watcher_v1_watch_pb.Request.deserializeBinary(new Uint8Array(buffer_arg));
}
...
// see [google.rpc.Code][].
var WatcherService = exports.WatcherService = {
  // Start a streaming RPC to get watch information from the server.
  watch: {
    path: '/google.watcher.v1.Watcher/Watch',
    requestStream: false,
    responseStream: true,
    requestType: google_watcher_v1_watch_pb.Request,
    responseType: google_watcher_v1_watch_pb.ChangeBatch,
    requestSerialize: serialize_google_watcher_v1_Request,
    requestDeserialize: deserialize_google_watcher_v1_Request,
    responseSerialize: serialize_google_watcher_v1_ChangeBatch,
    responseDeserialize: deserialize_google_watcher_v1_ChangeBatch,
  },
};

exports.WatcherClient = grpc.makeGenericClientConstructor(WatcherService);
