...
export class AssistResponse extends jspb.Message {
  getEventType(): AssistResponse.EventTypeMap[keyof AssistResponse.EventTypeMap];
  setEventType(value: AssistResponse.EventTypeMap[keyof AssistResponse.EventTypeMap]): void;
...
export namespace AssistResponse {
  export type AsObject = {
    eventType: AssistResponse.EventTypeMap[keyof AssistResponse.EventTypeMap],
...
export class AudioInConfig extends jspb.Message {
  getEncoding(): AudioInConfig.EncodingMap[keyof AudioInConfig.EncodingMap];
  setEncoding(value: AudioInConfig.EncodingMap[keyof AudioInConfig.EncodingMap]): void;
...
export namespace AudioInConfig {
  export type AsObject = {
    encoding: AudioInConfig.EncodingMap[keyof AudioInConfig.EncodingMap],
...
export class AudioOutConfig extends jspb.Message {
  getEncoding(): AudioOutConfig.EncodingMap[keyof AudioOutConfig.EncodingMap];
  setEncoding(value: AudioOutConfig.EncodingMap[keyof AudioOutConfig.EncodingMap]): void;
...
export namespace AudioOutConfig {
  export type AsObject = {
    encoding: AudioOutConfig.EncodingMap[keyof AudioOutConfig.EncodingMap],
    sampleRateHertz: number,
...
export class ScreenOutConfig extends jspb.Message {
  getScreenMode(): ScreenOutConfig.ScreenModeMap[keyof ScreenOutConfig.ScreenModeMap];
  setScreenMode(value: ScreenOutConfig.ScreenModeMap[keyof ScreenOutConfig.ScreenModeMap]): void;
...
export namespace ScreenOutConfig {
  export type AsObject = {
    screenMode: ScreenOutConfig.ScreenModeMap[keyof ScreenOutConfig.ScreenModeMap],
  }

  export interface ScreenModeMap {
    SCREEN_MODE_UNSPECIFIED: 0;
    OFF: 1;
    PLAYING: 3;
  }

  export const ScreenMode: ScreenModeMap;
}
...
export class ScreenOut extends jspb.Message {
  getFormat(): ScreenOut.FormatMap[keyof ScreenOut.FormatMap];
  setFormat(value: ScreenOut.FormatMap[keyof ScreenOut.FormatMap]): void;
...
export namespace ScreenOut {
  export type AsObject = {
    format: ScreenOut.FormatMap[keyof ScreenOut.FormatMap],
...
export class DialogStateOut extends jspb.Message {
  ...
  getMicrophoneMode(): DialogStateOut.MicrophoneModeMap[keyof DialogStateOut.MicrophoneModeMap];
  setMicrophoneMode(value: DialogStateOut.MicrophoneModeMap[keyof DialogStateOut.MicrophoneModeMap]): void;
...
export namespace DialogStateOut {
  export type AsObject = {
    ...
    conversationState: Uint8Array | string,
    microphoneMode: DialogStateOut.MicrophoneModeMap[keyof DialogStateOut.MicrophoneModeMap],
    volumePercentage: number,
  }

  export interface MicrophoneModeMap {
    MICROPHONE_MODE_UNSPECIFIED: 0;
    CLOSE_MICROPHONE: 1;
    DIALOG_FOLLOW_ON: 2;
  }

  export const MicrophoneMode: MicrophoneModeMap;
}
