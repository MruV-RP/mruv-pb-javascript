...
export class ConverseResult extends jspb.Message {
  ...
  getMicrophoneMode(): ConverseResult.MicrophoneModeMap[keyof ConverseResult.MicrophoneModeMap];
  setMicrophoneMode(value: ConverseResult.MicrophoneModeMap[keyof ConverseResult.MicrophoneModeMap]): void;
...
export namespace ConverseResult {
  export type AsObject = {
    ...
    conversationState: Uint8Array | string,
    microphoneMode: ConverseResult.MicrophoneModeMap[keyof ConverseResult.MicrophoneModeMap],
    volumePercentage: number,
  }
...
export class ConverseResponse extends jspb.Message {
  ...
  clearEventType(): void;
  getEventType(): ConverseResponse.EventTypeMap[keyof ConverseResponse.EventTypeMap];
  setEventType(value: ConverseResponse.EventTypeMap[keyof ConverseResponse.EventTypeMap]): void;
...
export namespace ConverseResponse {
  export type AsObject = {
    ...
    eventType: ConverseResponse.EventTypeMap[keyof ConverseResponse.EventTypeMap],
