...
export class ListTasksRequest extends jspb.Message {
  ...
  getResponseView(): google_cloud_tasks_v2_task_pb.Task.ViewMap[keyof google_cloud_tasks_v2_task_pb.Task.ViewMap];
  setResponseView(value: google_cloud_tasks_v2_task_pb.Task.ViewMap[keyof google_cloud_tasks_v2_task_pb.Task.ViewMap]): void;
...
export namespace ListTasksRequest {
  export type AsObject = {
    parent: string,
    responseView: google_cloud_tasks_v2_task_pb.Task.ViewMap[keyof google_cloud_tasks_v2_task_pb.Task.ViewMap],
    pageSize: number,
    pageToken: string,
  }
}
