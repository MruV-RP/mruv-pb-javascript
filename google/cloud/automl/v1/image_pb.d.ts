...
// file: google/cloud/automl/v1/image.proto
...
export class ImageClassificationDatasetMetadata extends jspb.Message {
  getClassificationType(): google_cloud_automl_v1_classification_pb.ClassificationTypeMap[keyof google_cloud_automl_v1_classification_pb.ClassificationTypeMap];
  setClassificationType(value: google_cloud_automl_v1_classification_pb.ClassificationTypeMap[keyof google_cloud_automl_v1_classification_pb.ClassificationTypeMap]): void;
...
export namespace ImageClassificationDatasetMetadata {
  export type AsObject = {
    classificationType: google_cloud_automl_v1_classification_pb.ClassificationTypeMap[keyof google_cloud_automl_v1_classification_pb.ClassificationTypeMap],
  }
}
