...
export class QueryParameters extends jspb.Message {
  ...
  addKnowledgeBaseNames(value: string, index?: number): string;
...
export namespace KnowledgeAnswers {
  ...
  export class Answer extends jspb.Message {
    ...
    getMatchConfidenceLevel(): KnowledgeAnswers.Answer.MatchConfidenceLevelMap[keyof KnowledgeAnswers.Answer.MatchConfidenceLevelMap];
    setMatchConfidenceLevel(value: KnowledgeAnswers.Answer.MatchConfidenceLevelMap[keyof KnowledgeAnswers.Answer.MatchConfidenceLevelMap]): void;
  ...
  export namespace Answer {
    export type AsObject = {
      ...
      faqQuestion: string,
      answer: string,
      matchConfidenceLevel: KnowledgeAnswers.Answer.MatchConfidenceLevelMap[keyof KnowledgeAnswers.Answer.MatchConfidenceLevelMap],
      matchConfidence: number,
    }

    export interface MatchConfidenceLevelMap {
    ...
    export const MatchConfidenceLevel: MatchConfidenceLevelMap;
  }
}
