...
// file: google/cloud/websecurityscanner/v1beta/scan_config.proto
...
export class ScanConfig extends jspb.Message {
  ...
  getExportToSecurityCommandCenter(): ScanConfig.ExportToSecurityCommandCenterMap[keyof ScanConfig.ExportToSecurityCommandCenterMap];
  setExportToSecurityCommandCenter(value: ScanConfig.ExportToSecurityCommandCenterMap[keyof ScanConfig.ExportToSecurityCommandCenterMap]): void;
  ...
  getRiskLevel(): ScanConfig.RiskLevelMap[keyof ScanConfig.RiskLevelMap];
  setRiskLevel(value: ScanConfig.RiskLevelMap[keyof ScanConfig.RiskLevelMap]): void;
...
export namespace ScanConfig {
  export type AsObject = {
    ...
    exportToSecurityCommandCenter: ScanConfig.ExportToSecurityCommandCenterMap[keyof ScanConfig.ExportToSecurityCommandCenterMap],
    latestRun?: google_cloud_websecurityscanner_v1beta_scan_run_pb.ScanRun.AsObject,
    riskLevel: ScanConfig.RiskLevelMap[keyof ScanConfig.RiskLevelMap],
  }
  ...
  export interface ExportToSecurityCommandCenterMap {
    EXPORT_TO_SECURITY_COMMAND_CENTER_UNSPECIFIED: 0;
    ENABLED: 1;
    DISABLED: 2;
  }

  export const ExportToSecurityCommandCenter: ExportToSecurityCommandCenterMap;
}
