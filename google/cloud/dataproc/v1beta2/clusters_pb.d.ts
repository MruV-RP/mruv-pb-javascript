...
export class SoftwareConfig extends jspb.Message {
  ...
  getOptionalComponentsList(): Array<google_cloud_dataproc_v1beta2_shared_pb.ComponentMap[keyof google_cloud_dataproc_v1beta2_shared_pb.ComponentMap]>;
  setOptionalComponentsList(value: Array<google_cloud_dataproc_v1beta2_shared_pb.ComponentMap[keyof google_cloud_dataproc_v1beta2_shared_pb.ComponentMap]>): void;
  addOptionalComponents(value: google_cloud_dataproc_v1beta2_shared_pb.ComponentMap[keyof google_cloud_dataproc_v1beta2_shared_pb.ComponentMap], index?: number): google_cloud_dataproc_v1beta2_shared_pb.ComponentMap[keyof google_cloud_dataproc_v1beta2_shared_pb.ComponentMap];
...
export namespace SoftwareConfig {
  export type AsObject = {
    ...
    optionalComponentsList: Array<google_cloud_dataproc_v1beta2_shared_pb.ComponentMap[keyof google_cloud_dataproc_v1beta2_shared_pb.ComponentMap]>,
  }
}
...
export class ReservationAffinity extends jspb.Message {
  getConsumeReservationType(): ReservationAffinity.TypeMap[keyof ReservationAffinity.TypeMap];
  setConsumeReservationType(value: ReservationAffinity.TypeMap[keyof ReservationAffinity.TypeMap]): void;
...
export namespace ReservationAffinity {
  export type AsObject = {
    consumeReservationType: ReservationAffinity.TypeMap[keyof ReservationAffinity.TypeMap],
    key: string,
