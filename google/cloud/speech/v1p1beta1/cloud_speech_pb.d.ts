...
export class RecognitionConfig extends jspb.Message {
  getEncoding(): RecognitionConfig.AudioEncodingMap[keyof RecognitionConfig.AudioEncodingMap];
  setEncoding(value: RecognitionConfig.AudioEncodingMap[keyof RecognitionConfig.AudioEncodingMap]): void;
  ...
  addAlternativeLanguageCodes(value: string, index?: number): string;
...
export namespace RecognitionConfig {
  export type AsObject = {
    encoding: RecognitionConfig.AudioEncodingMap[keyof RecognitionConfig.AudioEncodingMap],
...
export class RecognitionMetadata extends jspb.Message {
  getInteractionType(): RecognitionMetadata.InteractionTypeMap[keyof RecognitionMetadata.InteractionTypeMap];
  setInteractionType(value: RecognitionMetadata.InteractionTypeMap[keyof RecognitionMetadata.InteractionTypeMap]): void;

  getIndustryNaicsCodeOfAudio(): number;
  setIndustryNaicsCodeOfAudio(value: number): void;

  getMicrophoneDistance(): RecognitionMetadata.MicrophoneDistanceMap[keyof RecognitionMetadata.MicrophoneDistanceMap];
  setMicrophoneDistance(value: RecognitionMetadata.MicrophoneDistanceMap[keyof RecognitionMetadata.MicrophoneDistanceMap]): void;

  getOriginalMediaType(): RecognitionMetadata.OriginalMediaTypeMap[keyof RecognitionMetadata.OriginalMediaTypeMap];
  setOriginalMediaType(value: RecognitionMetadata.OriginalMediaTypeMap[keyof RecognitionMetadata.OriginalMediaTypeMap]): void;

  getRecordingDeviceType(): RecognitionMetadata.RecordingDeviceTypeMap[keyof RecognitionMetadata.RecordingDeviceTypeMap];
  setRecordingDeviceType(value: RecognitionMetadata.RecordingDeviceTypeMap[keyof RecognitionMetadata.RecordingDeviceTypeMap]): void;
...
export namespace RecognitionMetadata {
  export type AsObject = {
    interactionType: RecognitionMetadata.InteractionTypeMap[keyof RecognitionMetadata.InteractionTypeMap],
    industryNaicsCodeOfAudio: number,
    microphoneDistance: RecognitionMetadata.MicrophoneDistanceMap[keyof RecognitionMetadata.MicrophoneDistanceMap],
    originalMediaType: RecognitionMetadata.OriginalMediaTypeMap[keyof RecognitionMetadata.OriginalMediaTypeMap],
    recordingDeviceType: RecognitionMetadata.RecordingDeviceTypeMap[keyof RecognitionMetadata.RecordingDeviceTypeMap],
  ...
  export interface MicrophoneDistanceMap {
  ...
  export const MicrophoneDistance: MicrophoneDistanceMap;

  export interface OriginalMediaTypeMap {
    ORIGINAL_MEDIA_TYPE_UNSPECIFIED: 0;
    AUDIO: 1;
    VIDEO: 2;
  }

  export const OriginalMediaType: OriginalMediaTypeMap;

  export interface RecordingDeviceTypeMap {
  ...
  export const RecordingDeviceType: RecordingDeviceTypeMap;
}
...
export class StreamingRecognizeResponse extends jspb.Message {
  ...
  getSpeechEventType(): StreamingRecognizeResponse.SpeechEventTypeMap[keyof StreamingRecognizeResponse.SpeechEventTypeMap];
  setSpeechEventType(value: StreamingRecognizeResponse.SpeechEventTypeMap[keyof StreamingRecognizeResponse.SpeechEventTypeMap]): void;
...
export namespace StreamingRecognizeResponse {
  export type AsObject = {
    ...
    speechEventType: StreamingRecognizeResponse.SpeechEventTypeMap[keyof StreamingRecognizeResponse.SpeechEventTypeMap],
  }

  export interface SpeechEventTypeMap {
    SPEECH_EVENT_UNSPECIFIED: 0;
    END_OF_SINGLE_UTTERANCE: 1;
  }

  export const SpeechEventType: SpeechEventTypeMap;
}
