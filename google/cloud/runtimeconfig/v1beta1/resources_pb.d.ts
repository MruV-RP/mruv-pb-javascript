...
export class Variable extends jspb.Message {
  ...
  getState(): VariableStateMap[keyof VariableStateMap];
  setState(value: VariableStateMap[keyof VariableStateMap]): void;
...
export namespace Variable {
  export type AsObject = {
    ...
    state: VariableStateMap[keyof VariableStateMap],
  }
...
export interface VariableStateMap {
  VARIABLE_STATE_UNSPECIFIED: 0;
  UPDATED: 1;
  DELETED: 2;
}

export const VariableState: VariableStateMap;
