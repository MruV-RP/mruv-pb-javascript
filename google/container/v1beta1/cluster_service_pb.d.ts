...
// file: google/container/v1beta1/cluster_service.proto
...
export class IstioConfig extends jspb.Message {
  ...
  getAuth(): IstioConfig.IstioAuthModeMap[keyof IstioConfig.IstioAuthModeMap];
  setAuth(value: IstioConfig.IstioAuthModeMap[keyof IstioConfig.IstioAuthModeMap]): void;
...
export namespace IstioConfig {
  export type AsObject = {
    disabled: boolean,
    auth: IstioConfig.IstioAuthModeMap[keyof IstioConfig.IstioAuthModeMap],
  }

  export interface IstioAuthModeMap {
    AUTH_NONE: 0;
    AUTH_MUTUAL_TLS: 1;
  }

  export const IstioAuthMode: IstioAuthModeMap;
}
...
export class WorkloadMetadataConfig extends jspb.Message {
  getNodeMetadata(): WorkloadMetadataConfig.NodeMetadataMap[keyof WorkloadMetadataConfig.NodeMetadataMap];
  setNodeMetadata(value: WorkloadMetadataConfig.NodeMetadataMap[keyof WorkloadMetadataConfig.NodeMetadataMap]): void;
...
export namespace WorkloadMetadataConfig {
  export type AsObject = {
    nodeMetadata: WorkloadMetadataConfig.NodeMetadataMap[keyof WorkloadMetadataConfig.NodeMetadataMap],
  }
  ...
  export const NodeMetadata: NodeMetadataMap;
}
...
export class Location extends jspb.Message {
  getType(): Location.LocationTypeMap[keyof Location.LocationTypeMap];
  setType(value: Location.LocationTypeMap[keyof Location.LocationTypeMap]): void;
...
export namespace Location {
  export type AsObject = {
    type: Location.LocationTypeMap[keyof Location.LocationTypeMap],
    name: string,
    recommended: boolean,
  }
...
export class StatusCondition extends jspb.Message {
  getCode(): StatusCondition.CodeMap[keyof StatusCondition.CodeMap];
  setCode(value: StatusCondition.CodeMap[keyof StatusCondition.CodeMap]): void;
...
export namespace StatusCondition {
  export type AsObject = {
    code: StatusCondition.CodeMap[keyof StatusCondition.CodeMap],
    message: string,
  }
...
export class UsableSubnetworkSecondaryRange extends jspb.Message {
  ...
  getStatus(): UsableSubnetworkSecondaryRange.StatusMap[keyof UsableSubnetworkSecondaryRange.StatusMap];
  setStatus(value: UsableSubnetworkSecondaryRange.StatusMap[keyof UsableSubnetworkSecondaryRange.StatusMap]): void;
...
export namespace UsableSubnetworkSecondaryRange {
  export type AsObject = {
    rangeName: string,
    ipCidrRange: string,
    status: UsableSubnetworkSecondaryRange.StatusMap[keyof UsableSubnetworkSecondaryRange.StatusMap],
  }
