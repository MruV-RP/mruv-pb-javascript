...
// file: google/container/v1/cluster_service.proto
...
export class ClusterAutoscaling extends jspb.Message {
  ...
  addAutoprovisioningLocations(value: string, index?: number): string;
...
export class DatabaseEncryption extends jspb.Message {
  getState(): DatabaseEncryption.StateMap[keyof DatabaseEncryption.StateMap];
  setState(value: DatabaseEncryption.StateMap[keyof DatabaseEncryption.StateMap]): void;
...
export namespace DatabaseEncryption {
  export type AsObject = {
    state: DatabaseEncryption.StateMap[keyof DatabaseEncryption.StateMap],
    keyName: string,
  }
