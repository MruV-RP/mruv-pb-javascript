...
interface IServiceManagerService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  enableService: grpc.MethodDefinition<google_api_servicemanagement_v1_servicemanager_pb.EnableServiceRequest, google_longrunning_operations_pb.Operation>;
  disableService: grpc.MethodDefinition<google_api_servicemanagement_v1_servicemanager_pb.DisableServiceRequest, google_longrunning_operations_pb.Operation>;
}
...
export class ServiceManagerClient extends grpc.Client {
  ...
  enableService(argument: google_api_servicemanagement_v1_servicemanager_pb.EnableServiceRequest, callback: grpc.requestCallback<google_longrunning_operations_pb.Operation>): grpc.ClientUnaryCall;
  enableService(argument: google_api_servicemanagement_v1_servicemanager_pb.EnableServiceRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<google_longrunning_operations_pb.Operation>): grpc.ClientUnaryCall;
  enableService(argument: google_api_servicemanagement_v1_servicemanager_pb.EnableServiceRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<google_longrunning_operations_pb.Operation>): grpc.ClientUnaryCall;
  disableService(argument: google_api_servicemanagement_v1_servicemanager_pb.DisableServiceRequest, callback: grpc.requestCallback<google_longrunning_operations_pb.Operation>): grpc.ClientUnaryCall;
  disableService(argument: google_api_servicemanagement_v1_servicemanager_pb.DisableServiceRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<google_longrunning_operations_pb.Operation>): grpc.ClientUnaryCall;
  disableService(argument: google_api_servicemanagement_v1_servicemanager_pb.DisableServiceRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<google_longrunning_operations_pb.Operation>): grpc.ClientUnaryCall;
}
